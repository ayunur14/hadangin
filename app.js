...
const ENGLISH_PHRASES = new Map([
  ...
  ["Identitas HADANGIN", "HADANGIN Identity"], ["Hadang Informasi. Jaga Keputusan.", "Block Information. Protect Decisions."],
  ...
  ["Gerak", "Movement"], ["Batas", "Boundary"], ["Hadang", "Block"], ["Perilaku digital", "Digital Behavior"], ["Informasi", "Information"], ["Tindakan aman", "Safe Action"],
  ...
  ["Mode komunitas · 4–120 peserta", "Community Mode · 4–120 Participants"], ["Hadang informasi sebagai permainan tim.", "Block Information Through Team Play."],
...
function downloadCommunityKit() {
  ...
  const guide = english
    ? (communityState.mode === "vision" ? visionGuideEn : `${offlineGuideEn}${offlineGuideDetailsEn}`)
