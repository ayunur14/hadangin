...
function aboutPage() {
  return `<section class="page-hero about-hero"><img class="about-hero-mark" src="${HADANGIN_MARK_URL}" alt="" aria-hidden="true" /><div class="page-shell about-hero-inner"><div class="about-wordmark-shell"><img src="${HADANGIN_WORDMARK_URL}" alt="HADANGIN" /></div><p class="eyebrow">Identitas HADANGIN</p><h1>Hadang Informasi. Jaga Keputusan.</h1><p>HADANGIN membantu orang melatih jeda yang dapat diulang antara tekanan psikologis dan tindakan digital. Saat desakan, rasa takut, otoritas, atau ancaman memicu kepanikan, J.E.D.A. memandu pengguna memperlambat respons, memeriksa konteks dan bukti, lalu memilih secara sadar alih-alih bereaksi impulsif.</p><div class="about-behavioral-scope"><span>PEMBENTUKAN KEBIASAAN PERILAKU</span><p><strong>Lebih dari sekadar edukasi.</strong> HADANGIN melatih rutinitas pengambilan keputusan yang lebih aman melalui praktik berulang. Dengan membiasakan jeda, pemeriksaan bukti, dan pilihan yang sadar, pengguna membangun pola respons yang dapat mereka bawa ke berbagai situasi digital sehari-hari.</p></div><div class="about-hero-principles"><span>Human First</span><i></i><span>AI Second</span><i></i><span>Human Final</span></div></div></section>
    ...
    <section class="section about-embodied"><div class="page-shell"><header class="about-embodied-head"><div><p class="section-kicker">Embodied MIL Learning</p><h2>Mengapa gerak dalam Gobak Sodor penting?</h2></div><p>HADANGIN mengubah literasi media dan informasi dari sesuatu yang hanya dibaca menjadi pengalaman yang dilatih melalui gerak. Pemain membawa informasi, menghadapi batas, berhenti di checkpoint J.E.D.A., memeriksa bukti, dan mempertahankan keputusan bersama.</p></header><div class="about-embodied-grid"><article><span>01 / GERAK</span><h3>Informasi dibuat terlihat.</h3><p>Informasi bergerak dari pemicu menuju tindakan. Batas fisik memberi peserta momen konkret untuk berhenti dan menilai sebelum melintas.</p></article><article><span>02 / PENGULANGAN</span><h3>Rutinitas dilatih dalam setiap ronde.</h3><p>Setiap permainan mengulang urutan J.E.D.A.: berhenti, mengenali tekanan, memeriksa bukti, lalu memilih tindakan dengan sadar.</p></article><article><span>03 / PENALARAN SOSIAL</span><h3>Keputusan harus dapat dijelaskan.</h3><p>Peserta menyampaikan alasan, mendengar sudut pandang tim lain, dan membandingkan bukti sebelum informasi boleh diloloskan.</p></article><article><span>04 / KONEKSI BUDAYA</span><h3>Permainan lokal membawa pelajaran global.</h3><p>Gobak Sodor membuat konsep literasi digital yang abstrak menjadi pengalaman bersama yang dekat, aktif, dan mudah dikenali lintas generasi.</p></article></div><div class="about-embodied-outcome"><strong>Dari pengalaman bersama menuju kebiasaan pribadi.</strong><p>Yang dilatih di arena bukan sekadar jawaban benar, melainkan urutan respons yang dapat dibawa ke situasi digital sehari-hari: jeda, bertanya, periksa, lalu putuskan.</p><small>Pendekatan ini dirancang untuk mendukung keterlibatan dan pembentukan kebiasaan; dampaknya tetap perlu dievaluasi melalui pengujian pengguna.</small></div></div></section>
