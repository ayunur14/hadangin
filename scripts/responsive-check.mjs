...
const cases = [
  ...
  { name: "community-prepare", route: "community", setup: "document.querySelector('[data-action=\"reset-community\"]')?.click(); document.querySelector('[data-action=\"start-community\"]').click();" },
  { name: "community-vote", route: "community", setup: "document.querySelector('[data-action=\"reset-community\"]')?.click(); document.querySelector('[data-action=\"start-community\"]').click(); for (const item of [0,1,2,3]) document.querySelector('[data-community-prep=\"' + item + '\"]').click(); document.querySelector('[data-action=\"community-next\"]').click();" },
  { name: "community-arena", route: "community", setup: "document.querySelector('[data-action=\"reset-community\"]')?.click(); document.querySelector('[data-action=\"start-community\"]').click(); for (const item of [0,1,2,3]) document.querySelector('[data-community-prep=\"' + item + '\"]').click(); document.querySelector('[data-action=\"community-next\"]').click(); document.querySelector('[data-action=\"community-next\"]').click();" },
  { name: "community-reveal", route: "community", setup: "document.querySelector('[data-action=\"reset-community\"]')?.click(); document.querySelector('[data-action=\"start-community\"]').click(); for (const item of [0,1,2,3]) document.querySelector('[data-community-prep=\"' + item + '\"]').click(); document.querySelector('[data-action=\"community-next\"]').click(); document.querySelector('[data-action=\"community-next\"]').click(); for (const answer of [0,0,1,1]) { document.querySelector('[data-community-answer=\"' + answer + '\"]').click(); document.querySelector('[data-action=\"community-lock-answer\"]').click(); document.querySelector('[data-action=\"community-next-line\"]').click(); }" },
  { name: "community-final-vote", route: "community", setup: "document.querySelector('[data-action=\"reset-community\"]')?.click(); document.querySelector('[data-action=\"start-community\"]').click(); for (const item of [0,1,2,3]) document.querySelector('[data-community-prep=\"' + item + '\"]').click(); document.querySelector('[data-action=\"community-next\"]').click(); document.querySelector('[data-action=\"community-next\"]').click(); for (const answer of [0,0,1,1]) { document.querySelector('[data-community-answer=\"' + answer + '\"]').click(); document.querySelector('[data-action=\"community-lock-answer\"]').click(); document.querySelector('[data-action=\"community-next-line\"]').click(); } document.querySelector('[data-community-tactic=\"urgency\"]').click(); document.querySelector('[data-action=\"community-next\"]').click();" },
  ...
  { name: "training-xai-family", route: "verify", setup: "startScenario('family-emergency'); state.stage = 4; render();" },
  { name: "training-xai-qr", route: "verify", setup: "startScenario('qr-payment'); state.stage = 4; render();" },
  { name: "training-xai-job", route: "verify", setup: "startScenario('job-offer'); state.stage = 4; render();" },
  { name: "training-xai-bank", route: "verify", setup: "startScenario('bank-message'); state.stage = 4; render();" },
  { name: "training-xai-viral", route: "verify", setup: "startScenario('viral-info'); state.stage = 4; render();" },
  { name: "training-xai-media", route: "verify", setup: "startScenario('manipulated-media'); state.stage = 4; render();" },
  { name: "training-xai-ai-wrong", route: "verify", setup: "startScenario('ai-can-be-wrong'); state.stage = 4; render();" },
  { name: "training-xai-audio", route: "verify", setup: "startScenario('audio-impersonation'); state.stage = 4; render();" },
...
try {
  ...
  for (const [width, height] of viewports) {
    ...
    for (const testCase of cases) {
      ...
      await cdp.send("Emulation.setDeviceMetricsOverride", { width, height, deviceScaleFactor: 1, mobile: width <= 768 });
      if (testCase.setup) {
        try { await evaluate(cdp, testCase.setup); }
        catch (error) { throw new Error(`${testCase.name} at ${width}x${height}: ${error.message}`); }
      }
