(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`Nak, Mama kecelakaan. HP Mama rusak. Transfer Rp3 juta sekarang ke rekening ini. Tolong cepat, ya!`,t=new URL(`/assets/tolong_buatkan_video_songnya-B60BK3da.mp4`,``+import.meta.url).href,n=[{id:`family-emergency`,no:`01`,title:`Pesan Keluarga Darurat`,description:`Nomor baru mengaku sebagai keluarga dan meminta transfer segera.`,triggers:[`Urgency`,`Fear`,`Attachment`],content:e,featured:!0},{id:`qr-payment`,no:`02`,title:`QR Pembayaran`,description:`QR pengganti ditempel di atas kode pembayaran resmi sebuah merchant.`,triggers:[`Trust`,`Habit`,`Convenience`],content:`QR di meja kasir sedang bermasalah. Scan kode baru ini agar pembayaran langsung diproses.`},{id:`job-offer`,no:`03`,title:`Lowongan Kerja`,description:`Tawaran kerja bergaji tinggi meminta deposit untuk proses administrasi.`,triggers:[`Hope`,`Authority`,`Scarcity`],content:`Selamat, Anda lolos seleksi awal. Transfer biaya administrasi hari ini untuk mengamankan posisi.`},{id:`bank-message`,no:`04`,title:`Pesan Bank`,description:`Pesan mengancam pemblokiran rekening dan mengarahkan ke sebuah tautan.`,triggers:[`Fear`,`Authority`,`Urgency`],content:`Rekening Anda akan diblokir dalam 30 menit. Klik tautan ini untuk verifikasi identitas.`},{id:`viral-info`,no:`05`,title:`Informasi Viral`,description:`Unggahan emosional mendorong pengguna menyebarkan klaim tanpa sumber.`,triggers:[`Anger`,`Social Pressure`],content:`Mereka tidak ingin kamu tahu fakta ini. Sebarkan sekarang sebelum unggahan dihapus!`},{id:`manipulated-media`,no:`06`,title:`Media Manipulatif`,description:`Video tokoh publik tampak nyata, tetapi konteks dan sumbernya tidak jelas.`,triggers:[`Realism`,`Authority`],content:`Video eksklusif tokoh publik membagikan peluang investasi yang hanya tersedia hari ini.`},{id:`ai-can-be-wrong`,no:`07`,title:`AI Bisa Salah`,description:`Bukti resmi dapat lebih kuat daripada sinyal AI. Latih keberanian untuk tidak setuju.`,triggers:[`Automation Bias`],content:`Pemberitahuan resmi: jadwal layanan berubah. Periksa pembaruan pada aplikasi resmi.`,aiWrong:!0}],r={"family-emergency":{neutralOriginal:`MAMA KECELAKAAN! TRANSFER SEKARANG!`,neutralVersion:`Seseorang meminta kamu mentransfer Rp3.000.000.`,claim:`Pengirim mengaku sebagai ibu dan sedang mengalami keadaan darurat.`,evidenceOptions:[`Foto dari nomor tersebut`,`Voice note dari nomor tersebut`,`Nomor rekening yang diberikan`,`Telepon nomor ibu yang tersimpan`],preferredEvidence:`Telepon nomor ibu yang tersimpan`,actionOptions:[`Transfer`,`Klik`,`Berikan OTP`,`Share`],riskOptions:[`Kehilangan uang`,`Akun diambil alih`,`Data pribadi bocor`,`Misinformasi menyebar`],saferOptions:[`Telepon nomor tersimpan`,`Buka aplikasi resmi sendiri`,`Cari sumber independen`,`Tunggu dan cek ulang`],aiNotices:[[`Pressure`,`“sekarang”, “tolong cepat”`],[`Emotion`,`Emergency framing`],[`Identity`,`Identitas belum terkonfirmasi`],[`Requested action`,`Transfer segera`]],aiLevel:`High`,aiScore:82,unknowns:[`Identitas asli pengirim.`,`Apakah keadaan darurat benar terjadi.`,`Konteks lengkap di luar pesan ini.`,`Apakah model salah membaca sinyal.`],verification:[`Hubungi nomor keluarga yang tersimpan.`,`Periksa penerima sebelum pembayaran.`,`Tanya anggota keluarga lain.`,`Gunakan kanal di luar pesan ini.`]},"qr-payment":{neutralOriginal:`QR LAMA RUSAK. SCAN YANG BARU SEKARANG!`,neutralVersion:`Sebuah kode QR baru meminta kamu melakukan pembayaran.`,claim:`Kode QR baru diklaim sebagai kanal pembayaran resmi merchant.`,evidenceOptions:[`Logo merchant pada stiker`,`Warna QR yang terlihat resmi`,`Konfirmasi langsung kepada kasir`,`Jumlah orang yang sudah memindai`],preferredEvidence:`Konfirmasi langsung kepada kasir`,actionOptions:[`Scan`,`Transfer`,`Download`,`Berikan OTP`],riskOptions:[`Pembayaran masuk ke pihak salah`,`Data rekening bocor`,`Perangkat terinfeksi`,`Saldo tertahan`],saferOptions:[`Konfirmasi QR kepada kasir`,`Periksa nama penerima`,`Gunakan mesin pembayaran resmi`,`Batalkan dan cek ulang`],aiNotices:[[`Pressure`,`Dorongan menyelesaikan antrean`],[`Habit`,`Scan tanpa memeriksa penerima`],[`Identity`,`Pemilik QR belum terkonfirmasi`],[`Requested action`,`Pembayaran melalui QR baru`]],aiLevel:`Medium`,aiScore:74,unknowns:[`Siapa pemilik rekening tujuan.`,`Apakah QR benar diganti merchant.`,`Kondisi stiker sebelum difoto.`,`Apakah deteksi visual melewatkan perubahan.`],verification:[`Tanyakan QR resmi kepada kasir.`,`Periksa nama penerima sebelum membayar.`,`Bandingkan dengan QR di kasir utama.`,`Simpan bukti transaksi.`]},"job-offer":{neutralOriginal:`POSISI TERBATAS! BAYAR DEPOSIT HARI INI!`,neutralVersion:`Pihak yang menawarkan pekerjaan meminta biaya administrasi.`,claim:`Pengirim mengaku mewakili perusahaan dan menjanjikan posisi kerja.`,evidenceOptions:[`Testimoni di pesan`,`Logo perusahaan`,`Kontak HR pada situs resmi perusahaan`,`Screenshot slip gaji`],preferredEvidence:`Kontak HR pada situs resmi perusahaan`,actionOptions:[`Transfer`,`Kirim data pribadi`,`Download`,`Klik`],riskOptions:[`Kehilangan uang`,`Identitas disalahgunakan`,`Perangkat terinfeksi`,`Akun diambil alih`],saferOptions:[`Hubungi HR melalui situs resmi`,`Cari lowongan di kanal perusahaan`,`Tolak biaya di muka`,`Periksa legalitas perusahaan`],aiNotices:[[`Pressure`,`Posisi disebut terbatas`],[`Emotion`,`Harapan mendapat pekerjaan`],[`Authority`,`Mengatasnamakan perusahaan`],[`Requested action`,`Deposit administrasi`]],aiLevel:`High`,aiScore:88,unknowns:[`Hubungan pengirim dengan perusahaan.`,`Apakah posisi tersebut benar tersedia.`,`Keaslian dokumen yang dilampirkan.`,`Kebijakan rekrutmen perusahaan.`],verification:[`Cari lowongan pada situs resmi.`,`Hubungi HR melalui kontak independen.`,`Periksa domain email pengirim.`,`Jangan membayar biaya rekrutmen di muka.`]},"bank-message":{neutralOriginal:`REKENING DIBLOKIR 30 MENIT LAGI. KLIK!`,neutralVersion:`Sebuah pesan meminta verifikasi rekening melalui tautan.`,claim:`Pengirim mengaku sebagai bank dan menyatakan rekening akan diblokir.`,evidenceOptions:[`Logo bank di pesan`,`Nomor pengirim terlihat rapi`,`Notifikasi di aplikasi bank resmi`,`Tautan yang dikirim`],preferredEvidence:`Notifikasi di aplikasi bank resmi`,actionOptions:[`Klik`,`Berikan OTP`,`Download`,`Kirim data pribadi`],riskOptions:[`Akun diambil alih`,`Kehilangan uang`,`Data pribadi bocor`,`Perangkat terinfeksi`],saferOptions:[`Buka aplikasi bank sendiri`,`Hubungi nomor di kartu`,`Ketik alamat resmi secara manual`,`Tunggu dan cek notifikasi resmi`],aiNotices:[[`Pressure`,`Ancaman blokir dalam 30 menit`],[`Authority`,`Mengatasnamakan bank`],[`Link`,`Domain tujuan perlu diperiksa`],[`Requested action`,`Verifikasi identitas`]],aiLevel:`High`,aiScore:91,unknowns:[`Status rekening sebenarnya.`,`Pemilik domain tujuan.`,`Apakah bank mengirim pemberitahuan lain.`,`Identitas operator pesan.`],verification:[`Buka aplikasi bank tanpa memakai tautan.`,`Hubungi nomor resmi pada kartu.`,`Periksa domain di situs resmi bank.`,`Jangan pernah membagikan OTP.`]},"viral-info":{neutralOriginal:`SEBARKAN SEBELUM DIHAPUS! MEREKA MENUTUPI FAKTA!`,neutralVersion:`Sebuah unggahan membuat klaim tanpa menyertakan sumber yang jelas.`,claim:`Unggahan mengklaim informasi penting sedang sengaja disembunyikan.`,evidenceOptions:[`Jumlah share`,`Komentar yang setuju`,`Sumber primer dan laporan independen`,`Akun yang pertama mengirim`],preferredEvidence:`Sumber primer dan laporan independen`,actionOptions:[`Share`,`Klik`,`Download`,`Kirim data pribadi`],riskOptions:[`Misinformasi menyebar`,`Reputasi pihak dirugikan`,`Konflik meningkat`,`Data pribadi bocor`],saferOptions:[`Cari sumber primer`,`Baca laporan dari beberapa sumber`,`Periksa tanggal dan konteks`,`Tunda membagikan`],aiNotices:[[`Pressure`,`Dorongan menyebarkan segera`],[`Emotion`,`Kemarahan dan rasa curiga`],[`Source`,`Sumber primer tidak terlihat`],[`Requested action`,`Membagikan ulang`]],aiLevel:`Medium`,aiScore:77,unknowns:[`Asal klaim pertama.`,`Konteks kejadian lengkap.`,`Apakah materi sudah dipotong.`,`Motif akun yang menyebarkan.`],verification:[`Cari sumber primer.`,`Bandingkan laporan independen.`,`Periksa tanggal, lokasi, dan konteks.`,`Jangan jadikan viralitas sebagai bukti.`]},"manipulated-media":{neutralOriginal:`VIDEO ASLI! INVESTASI INI HANYA HARI INI!`,neutralVersion:`Sebuah video tokoh publik mempromosikan peluang investasi.`,claim:`Video diklaim menampilkan tokoh publik yang mendukung sebuah investasi.`,evidenceOptions:[`Wajah terlihat realistis`,`Banyak komentar positif`,`Pernyataan pada kanal resmi tokoh`,`Kualitas video tinggi`],preferredEvidence:`Pernyataan pada kanal resmi tokoh`,actionOptions:[`Investasi / pembelian`,`Klik`,`Transfer`,`Share`],riskOptions:[`Kehilangan uang`,`Misinformasi menyebar`,`Identitas disalahgunakan`,`Akun diambil alih`],saferOptions:[`Periksa kanal resmi tokoh`,`Cari unggahan asli`,`Periksa izin lembaga terkait`,`Tunda keputusan investasi`],aiNotices:[[`Visual`,`Sinkronisasi wajah perlu ditinjau`],[`Audio`,`Pola suara tampak tidak konsisten`],[`Context`,`Sumber unggahan tidak jelas`],[`Requested action`,`Investasi segera`]],aiLevel:`High`,aiScore:84,unknowns:[`Siapa pembuat video.`,`Apakah cuplikan sudah disunting.`,`Konteks rekaman asli.`,`Legalitas produk investasi.`],verification:[`Cari video pada kanal resmi tokoh.`,`Gunakan pencarian balik frame.`,`Periksa izin produk investasi.`,`Jangan bertindak hanya dari kemiripan visual.`]},"audio-impersonation":{neutralOriginal:`NAK, INI MAMA. TOLONG TRANSFER SEKARANG, JANGAN TELEPON DULU!`,neutralVersion:`Seseorang dalam rekaman suara meminta kamu mentransfer uang.`,claim:`Pembicara mengaku sebagai anggota keluarga dan sedang mengalami keadaan darurat.`,evidenceOptions:[`Suara terdengar mirip`,`Nomor pengirim memakai foto keluarga`,`Telepon nomor keluarga yang tersimpan`,`Rekaman menyebut nama panggilan`],preferredEvidence:`Telepon nomor keluarga yang tersimpan`,actionOptions:[`Transfer`,`Kirim voice note balasan`,`Berikan OTP`,`Teruskan rekaman`],riskOptions:[`Kehilangan uang`,`Identitas suara disalahgunakan`,`Akun diambil alih`,`Kepanikan menyebar`],saferOptions:[`Telepon nomor tersimpan`,`Ajukan pertanyaan rahasia keluarga`,`Konfirmasi ke anggota keluarga lain`,`Tunda transfer`],aiNotices:[[`Voice pattern`,`Pola prosodi tidak konsisten`],[`Urgency`,`Transfer diminta segera`],[`Identity`,`Kemiripan suara bukan bukti identitas`],[`Audio trace`,`Jejak kompresi terdeteksi`]],aiLevel:`High`,aiScore:81,unknowns:[`Identitas asli pembicara.`,`Apakah suara sintetis atau rekaman asli yang terkompresi.`,`Konteks sebelum dan sesudah potongan audio.`,`Apakah pola suara kebetulan mirip data referensi.`],verification:[`Telepon nomor keluarga yang sudah tersimpan.`,`Gunakan pertanyaan yang hanya diketahui keluarga.`,`Konfirmasi kepada anggota keluarga lain.`,`Jangan transfer berdasarkan kemiripan suara.`]},"ai-can-be-wrong":{neutralOriginal:`PEMBERITAHUAN RESMI: JADWAL LAYANAN BERUBAH.`,neutralVersion:`Sebuah layanan menginformasikan perubahan jadwal.`,claim:`Pemberitahuan menyatakan jadwal layanan resmi telah berubah.`,evidenceOptions:[`AI menandainya mencurigakan`,`Tampilan pesannya formal`,`Pembaruan yang sama di aplikasi resmi`,`Pendapat di media sosial`],preferredEvidence:`Pembaruan yang sama di aplikasi resmi`,actionOptions:[`Buka aplikasi resmi`,`Share`,`Klik`,`Download`],riskOptions:[`Salah memahami jadwal`,`Membagikan informasi usang`,`Mengabaikan pengumuman sah`,`Tidak ada risiko besar`],saferOptions:[`Cocokkan dengan aplikasi resmi`,`Hubungi layanan resmi`,`Periksa waktu publikasi`,`Gunakan kanal resmi lain`],aiNotices:[[`Language`,`Bahasa formal terdeteksi`],[`Pattern`,`Format mirip pesan massal`],[`Identity`,`Pengirim tampak resmi`],[`Requested action`,`Buka aplikasi resmi`]],aiLevel:`Medium`,aiScore:68,unknowns:[`AI tidak mengakses akun layananmu.`,`Model belum melihat bukti di aplikasi resmi.`,`Format resmi dapat menyerupai pesan palsu.`,`Sinyal model dapat menjadi false positive.`],verification:[`Cocokkan isi di aplikasi resmi.`,`Periksa pengirim pada kanal resmi.`,`Prioritaskan bukti yang dapat diverifikasi.`,`Tidak perlu mengikuti AI jika bukti lebih kuat.`]}},i={"family-emergency":{mode:`message`,title:`Pesan darurat keluarga`,subtitle:`Simulasi analisis teks WhatsApp`,summary:`Model menemukan tekanan aksi cepat, identitas belum terverifikasi, dan permintaan transfer yang sulit dibatalkan.`,confidenceLabel:`Manipulation likelihood`,highlights:[{label:`Urgency`,detail:`'sekarang' dan 'tolong cepat' mempersempit ruang berpikir.`,x:12,y:20,w:44,h:18},{label:`Identity gap`,detail:`Nomor baru mengaku keluarga tanpa bukti independen.`,x:36,y:44,w:48,h:18},{label:`Risky action`,detail:`Permintaan transfer muncul sebelum identitas dikonfirmasi.`,x:18,y:69,w:58,h:16}],clues:[`Tekanan waktu tinggi`,`Identitas pengirim belum dikonfirmasi`,`Aksi finansial diminta di awal`,`Kanal verifikasi independen tersedia`],reflectiveQuestions:[`Apakah kamu sudah menelepon nomor keluarga yang tersimpan?`,`Apa risiko jika transfer dilakukan sebelum konfirmasi?`,`Siapa sumber lain yang bisa mengonfirmasi keadaan darurat ini?`]},"qr-payment":{mode:`qr`,title:`QR pembayaran mencurigakan`,subtitle:`Simulasi analisis QR/link`,summary:`Model menandai kemungkinan QR pengganti, tetapi penerima pembayaran tetap harus diverifikasi langsung kepada merchant.`,confidenceLabel:`QR risk signal`,highlights:[{label:`Overlay`,detail:`Area stiker tampak seperti lapisan baru di atas permukaan lama.`,x:21,y:24,w:56,h:44},{label:`Recipient unknown`,detail:`Pemilik rekening tujuan belum terlihat sebelum pembayaran.`,x:18,y:73,w:64,h:14}],clues:[`QR baru menggantikan kanal lama`,`Penerima dana belum terlihat`,`Konteks kasir perlu dicek langsung`,`Pembayaran adalah aksi sulit dibatalkan`],reflectiveQuestions:[`Apakah nama penerima cocok dengan merchant?`,`Apakah kasir mengonfirmasi QR ini secara langsung?`,`Apakah ada kanal pembayaran resmi lain?`]},"job-offer":{mode:`message`,title:`Tawaran kerja berbiaya di muka`,subtitle:`Simulasi analisis teks rekrutmen`,summary:`Model menemukan kombinasi scarcity, otoritas palsu, dan permintaan deposit yang umum pada penipuan lowongan.`,confidenceLabel:`Scam pattern likelihood`,highlights:[{label:`Scarcity`,detail:`'posisi terbatas' mendorong keputusan cepat.`,x:14,y:19,w:48,h:18},{label:`Authority`,detail:`Mengatasnamakan perusahaan tanpa kanal resmi.`,x:26,y:43,w:54,h:18},{label:`Upfront fee`,detail:`Biaya administrasi diminta sebelum verifikasi HR.`,x:18,y:69,w:62,h:16}],clues:[`Ada biaya rekrutmen di muka`,`Klaim perusahaan belum diverifikasi`,`Tekanan waktu tinggi`,`Kontak HR resmi tersedia sebagai pembanding`],reflectiveQuestions:[`Apakah perusahaan resmi meminta deposit?`,`Apakah domain email pengirim cocok dengan perusahaan?`,`Bisakah posisi ini ditemukan di kanal karier resmi?`]},"bank-message":{mode:`link`,title:`Pesan bank dan tautan verifikasi`,subtitle:`Simulasi analisis teks + link`,summary:`Model menandai ancaman pemblokiran, otoritas bank, dan tautan verifikasi sebagai pola phishing berisiko tinggi.`,confidenceLabel:`Phishing likelihood`,highlights:[{label:`Threat`,detail:`Ancaman blokir 30 menit menciptakan rasa takut.`,x:12,y:18,w:55,h:18},{label:`External link`,detail:`Tautan mengarahkan keluar dari kanal resmi yang diketik sendiri.`,x:24,y:50,w:58,h:18},{label:`Credential risk`,detail:`Verifikasi identitas dapat berujung data pribadi/OTP.`,x:18,y:72,w:64,h:14}],clues:[`Menggunakan ancaman pemblokiran`,`Mengarahkan ke tautan`,`Mengatasnamakan institusi finansial`,`OTP dan kredensial tidak boleh dibagikan`],reflectiveQuestions:[`Apakah notifikasi yang sama ada di aplikasi bank resmi?`,`Apakah kamu mengetik alamat resmi sendiri, bukan dari link?`,`Apakah pesan meminta OTP atau data sensitif?`]},"viral-info":{mode:`message`,title:`Klaim viral tanpa sumber primer`,subtitle:`Simulasi analisis headline sosial`,summary:`Model menemukan ajakan menyebarkan segera, framing konspiratif, dan ketiadaan sumber primer.`,confidenceLabel:`Disinformation signal`,highlights:[{label:`Share pressure`,detail:`Ajakan menyebarkan muncul sebelum bukti diberikan.`,x:13,y:20,w:56,h:18},{label:`Conspiracy frame`,detail:`'mereka menutupi fakta' memancing curiga dan marah.`,x:22,y:45,w:58,h:18},{label:`No source`,detail:`Tidak ada sumber primer yang bisa diverifikasi.`,x:24,y:70,w:50,h:15}],clues:[`Viralitas dipakai sebagai tekanan sosial`,`Sumber primer tidak terlihat`,`Bahasa emosional kuat`,`Perlu cek tanggal dan konteks`],reflectiveQuestions:[`Sumber primer klaim ini apa?`,`Apakah ada laporan independen yang menyebut hal sama?`,`Apa dampaknya jika kamu share dan ternyata keliru?`]},"manipulated-media":{mode:`media`,title:`Video tokoh publik / media manipulatif`,subtitle:`Simulasi analisis visual + audio`,summary:`Model menandai area wajah, sinkronisasi audio, dan konteks unggahan sebagai sinyal yang perlu diverifikasi.`,confidenceLabel:`Synthetic media likelihood`,highlights:[{label:`Face sync`,detail:`Gerak mulut dan ekspresi tampak tidak sepenuhnya selaras.`,x:34,y:18,w:30,h:34},{label:`Hand / edge`,detail:`Tepi objek dan tangan tampak terlalu halus atau berubah bentuk.`,x:14,y:56,w:25,h:22},{label:`Call to invest`,detail:`Ajakan investasi segera muncul tanpa kanal resmi.`,x:47,y:67,w:38,h:16}],clues:[`Sinkronisasi wajah perlu diperiksa`,`Pola audio tampak tidak konsisten`,`Sumber unggahan tidak jelas`,`Ada ajakan finansial cepat`],reflectiveQuestions:[`Apakah video ini ada di kanal resmi tokoh?`,`Apakah ada versi asli dengan konteks lengkap?`,`Apakah produk investasi punya izin resmi?`]},"audio-impersonation":{mode:`audio`,title:`Rekaman suara impersonasi`,subtitle:`Simulasi pencocokan pola audio + transkrip`,summary:`Model simulasi menemukan tekanan transfer, perubahan prosodi, dan jejak kompresi. Kemiripan pola suara tidak membuktikan identitas pembicara.`,confidenceLabel:`Voice manipulation signal`,dataset:{name:`Voice Scam Pattern Set`,size:`18.420 sampel`,matches:`37 cluster serupa`},highlights:[{label:`Prosody shift`,detail:`Intonasi berubah tajam pada bagian permintaan transfer.`,start:`00:04`,end:`00:07`},{label:`Compression trace`,detail:`Ada pola kompresi berulang yang dapat berasal dari edit atau aplikasi pesan.`,start:`00:08`,end:`00:11`},{label:`Urgent instruction`,detail:`Frasa 'sekarang' dan 'jangan telepon' membatasi verifikasi.`,start:`00:12`,end:`00:16`}],clues:[`Kemiripan suara bukan bukti identitas`,`Ada larangan melakukan verifikasi`,`Aksi finansial diminta segera`,`Konteks rekaman tidak lengkap`],reflectiveQuestions:[`Sudahkah kamu menelepon nomor keluarga yang tersimpan?`,`Adakah pertanyaan yang hanya keluarga asli dapat jawab?`,`Apa risiko jika model salah membaca audio terkompresi?`]},"ai-can-be-wrong":{mode:`official`,title:`Kemungkinan false positive AI`,subtitle:`Simulasi analisis dengan bukti resmi lebih kuat`,summary:`Model menemukan format massal yang tampak mencurigakan, tetapi bukti pada aplikasi resmi dapat membantah sinyal AI.`,confidenceLabel:`Suspicious signal`,highlights:[{label:`Formal template`,detail:`Format pengumuman massal kadang mirip pesan palsu.`,x:14,y:22,w:54,h:18},{label:`Official channel needed`,detail:`Keputusan harus mengikuti bukti di aplikasi/kanal resmi.`,x:20,y:54,w:60,h:18}],clues:[`Sinyal AI tidak sama dengan kebenaran`,`Bukti resmi bisa lebih kuat`,`Format formal dapat memicu false positive`,`Manusia tetap memegang keputusan akhir`],reflectiveQuestions:[`Apakah aplikasi resmi menampilkan pengumuman yang sama?`,`Bukti mana yang lebih dapat diverifikasi daripada skor AI?`,`Kapan kamu perlu tidak setuju dengan AI?`]}};function a(){return r[u.scenarioId]||r[`family-emergency`]}function o(){return i[u.scenarioId]||i[`family-emergency`]}function s(){return u.inputType===`image`?r[`manipulated-media`]:u.inputType===`audio`?r[`audio-impersonation`]:u.inputType===`qr`?r[u.qrInputMode===`image`?`qr-payment`:`bank-message`]:a()}function c(){return u.inputType===`image`?i[`manipulated-media`]:u.inputType===`audio`?i[`audio-impersonation`]:u.inputType===`qr`?i[u.qrInputMode===`image`?`qr-payment`:`bank-message`]:o()}function l(e){try{return new URL(e).hostname}catch{return`domain-belum-terbaca`}}var u={route:`verify`,inputType:`text`,content:e,fileName:``,imageDataUrl:``,audioDataUrl:``,qrImageDataUrl:``,qrInputMode:`link`,xaiMode:`bounding`,audioXaiMode:`voice`,qrXaiMode:`risk`,inFlow:!1,directDetection:!1,stage:2,hadangStep:0,initialDecision:``,initialConfidence:68,pressure:[],emotion:[],neutralImpact:``,evidence:``,requestedAction:``,consequence:``,saferAction:``,finalDecision:``,finalConfidence:72,reflection:[],priority:``,result:!1,questionOpen:!0,gameScore:0,gameLives:3,gameCombo:1,gameCatches:0,gameRoundComplete:!1,gameOver:!1,guardY:54,scenarioId:`family-emergency`,aiWrong:!1},d=document.querySelector(`#app`),f=document.querySelector(`#toast`),p;function m(e=``){return String(e).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#039;`)}function h(e){clearTimeout(p),f.textContent=e,f.classList.add(`show`),p=setTimeout(()=>f.classList.remove(`show`),2800)}function g(){let e=location.hash.replace(/^#\/?/,``).split(`/`)[0];return e===`training`?`training`:e===`dashboard`?`dashboard`:e===`how-it-works`?`how`:e===`about`?`about`:`verify`}function _(){document.querySelectorAll(`[data-route]`).forEach(e=>{e.classList.toggle(`active`,e.dataset.route===u.route)}),document.querySelector(`.main-nav`).classList.remove(`open`),document.querySelector(`.menu-toggle`).setAttribute(`aria-expanded`,`false`)}function v(){Object.assign(u,{inFlow:!1,directDetection:!1,stage:2,hadangStep:0,initialDecision:``,initialConfidence:68,pressure:[],emotion:[],neutralImpact:``,evidence:``,requestedAction:``,consequence:``,saferAction:``,finalDecision:``,finalConfidence:72,reflection:[],priority:``,result:!1,questionOpen:!0,gameScore:0,gameLives:3,gameCombo:1,gameCatches:0,gameRoundComplete:!1,gameOver:!1,guardY:54,aiWrong:!1})}function y(e={}){ie(),window.dispatchEvent(new CustomEvent(`hadang:before-render`));let t=window.scrollY,n=document.querySelector(`.game-question-panel`)?.scrollTop||0;u.route=g(),_(),d.innerHTML=u.route===`training`?R():u.route===`dashboard`?Ce():u.route===`how`?we():u.route===`about`?z():u.inFlow?D():S(),window.dispatchEvent(new CustomEvent(`hadang:rendered`,{detail:{route:u.route}})),requestAnimationFrame(ae),document.body.classList.toggle(`game-active`,u.route===`verify`&&u.inFlow&&u.stage===3),requestAnimationFrame(()=>{if(e.preserveScroll){window.scrollTo({top:t,behavior:`instant`});let e=document.querySelector(`.game-question-panel`);e&&(e.scrollTop=n)}else window.scrollTo({top:0,behavior:`instant`})})}function b(){return`
    ...
    </section>`}function x(){return`<section class="section section-white onboarding-section" id="onboarding">
    ...
    </div>`}function C(e,t){return`<button class="tab ${u.inputType===e?`active`:``}" role="tab" aria-selected="${u.inputType===e}" data-input-type="${e}">${t}</button>`}function w(){if(u.inputType===`text`)return`<div class="input-zone"><textarea id="content-input" aria-label="Teks atau pesan mencurigakan" placeholder="Tempel pesan atau klaim di sini...">${m(u.content)}</textarea></div>`;if(u.inputType===`qr`){let e=`<div class="media-input-modes" role="group" aria-label="Cara memasukkan QR atau tautan"><button type="button" class="${u.qrInputMode===`link`?`active`:``}" data-qr-input-mode="link">Tempel Tautan</button><button type="button" class="${u.qrInputMode===`image`?`active`:``}" data-qr-input-mode="image">Upload QR</button></div>`;return u.qrInputMode===`image`?u.qrImageDataUrl?`${e}<div class="image-upload-preview qr-upload-preview" data-drop-zone><div class="uploaded-image-frame"><img src="${u.qrImageDataUrl}" alt="Preview QR ${m(u.fileName)}" /></div><div class="uploaded-file-meta"><div><span>QR siap diperiksa</span><strong>${m(u.fileName)}</strong><small>AI simulasi akan memetakan struktur QR dan tujuan yang terbaca.</small></div><div class="button-row"><label class="button button-secondary button-small" for="file-input">Ganti QR</label><button class="icon-remove" type="button" data-action="remove-qr" aria-label="Hapus QR" title="Hapus QR">&times;</button></div></div><input class="file-input" id="file-input" type="file" accept="image/*" /></div>`:`${e}<div class="input-zone" data-drop-zone><div class="upload-content"><div class="upload-symbol" aria-hidden="true">#</div><strong>Upload gambar QR</strong><p>Tarik screenshot atau foto QR ke sini. PNG, JPG, dan WEBP hingga 10 MB.</p><label class="button button-secondary" for="file-input">Pilih Gambar QR</label><input class="file-input" id="file-input" type="file" accept="image/*" /></div></div>`:`${e}<div class="link-input-zone"><div class="link-input-icon" aria-hidden="true">//</div><div><strong>Alamat tujuan yang ingin diperiksa</strong><p>Tautan tidak akan dibuka. Simulasi hanya membaca struktur alamatnya.</p></div><input id="content-input" type="url" aria-label="Tautan mencurigakan" placeholder="https://contoh-tautan.com/verifikasi" value="${u.content.startsWith(`http`)?m(u.content):``}" /><div class="link-safety-note"><span></span>Pratinjau aman: tanpa membuka situs tujuan</div></div>`}let e=u.inputType===`audio`;return e&&u.audioDataUrl?`<div class="audio-upload-preview" data-drop-zone><div class="audio-file-head"><div class="audio-file-icon" aria-hidden="true">~</div><div><span>Rekaman siap diperiksa</span><strong>${m(u.fileName)}</strong><small>Putar dan dengarkan konteks sebelum memulai.</small></div><button class="icon-remove" type="button" data-action="remove-audio" aria-label="Hapus audio" title="Hapus audio">&times;</button></div>${T(42,`input-wave`)}<audio controls preload="metadata" src="${u.audioDataUrl}">Browser tidak mendukung pemutar audio.</audio><label class="button button-secondary button-small" for="file-input">Ganti Audio</label><input class="file-input" id="file-input" type="file" accept="audio/*" /></div>`:!e&&u.imageDataUrl?`<div class="image-upload-preview" data-drop-zone>
      <div class="uploaded-image-frame"><img src="${u.imageDataUrl}" alt="Preview ${m(u.fileName)}" /></div>
      <div class="uploaded-file-meta"><div><span>Gambar siap diperiksa</span><strong>${m(u.fileName)}</strong><small>Gambar akan tetap terlihat sampai tahap Explainable AI.</small></div><div class="button-row"><label class="button button-secondary button-small" for="file-input">Ganti Gambar</label><button class="icon-remove" type="button" data-action="remove-image" aria-label="Hapus gambar" title="Hapus gambar">&times;</button></div></div>
      <input class="file-input" id="file-input" type="file" accept="image/*" />
    </div>`:`<div class="input-zone" data-drop-zone><div class="upload-content"><div class="upload-symbol" aria-hidden="true">${e?`~`:`+`}</div><strong>${u.fileName?m(u.fileName):`Pilih ${e?`rekaman audio`:`gambar atau screenshot`}`}</strong><p>${e?`Tarik MP3, WAV, atau M4A hingga 10 MB`:`Tarik gambar ke sini atau pilih PNG, JPG, dan WEBP hingga 10 MB`}</p><label class="button button-secondary" for="file-input">Pilih File</label><input class="file-input" id="file-input" type="file" accept="${e?`audio/*`:`image/*`}" /></div></div>`}function T(e=48,t=``){return`<div class="audio-waveform ${t}" aria-hidden="true">${Array.from({length:e},(e,t)=>`<i style="--amp:${22+(t*37+t*t*3)%70}%"></i>`).join(``)}</div>`}function E(){let e=[`Content`,`My Judgment`,`J.E.D.A.`,`AI Lens`,`Final Decision`,`Reflection`],t=u.result?6:u.stage;return`<div class="progress-wrap">
  ...
  </div>`}function D(){if(u.directDetection)return ve();let e=O();u.stage===3&&(e=M()),u.stage===4&&(e=ye()),u.stage===5&&(e=be()),u.stage===6&&(e=u.result?I():xe());let t=u.stage===3;return`${E()}<section class="flow-canvas ${t?`game-flow-canvas`:``}"><div class="${t?`game-flow-shell`:`page-shell`}">${e}</div></section>`}function O(){return`<div class="flow-card">
    ...
    <div class="question">
      ...
      <div class="choice-grid">${[`Lanjut`,`Verifikasi Dulu`,`Berhenti`,`Belum Yakin`].map(e=>j(e,u.initialDecision,`initial-decision`)).join(``)}</div>
    </div>
    <div class="question">
      <span class="question-label">Seberapa yakin kamu dengan keputusan itu?</span>
      ${A(`initial-confidence`,u.initialConfidence)}
      <p class="helper">AI belum akan ditampilkan sampai kamu menyelesaikan tahap berpikir awal.</p>
    </div>
    <div class="flow-actions"><button class="button button-ghost" data-action="cancel-flow">Kembali</button><button class="button" data-action="lock-initial" ${u.initialDecision?``:`disabled`}>Kunci Penilaian Awal</button></div>
  </div>`}function k(){return u.inputType===`image`&&u.imageDataUrl?`<div class="human-image-context"><img src="${u.imageDataUrl}" alt="Gambar yang sedang diperiksa" /><div><span class="label">Gambar yang diperiksa</span><strong>${m(u.fileName)}</strong><p>Amati konteks, sumber, detail visual, dan tindakan yang diminta sebelum melihat analisis AI.</p></div></div>`:u.inputType===`audio`&&u.audioDataUrl?`<div class="human-audio-context"><div><span class="label">Rekaman yang diperiksa</span><strong>${m(u.fileName)}</strong>${T(38,`human-wave`)}<audio controls preload="metadata" src="${u.audioDataUrl}"></audio></div><div class="transcript-preview"><span>Transkrip simulasi</span><p>"Nak, ini Mama. Nomor Mama sedang bermasalah. Tolong transfer sekarang dan jangan telepon dulu."</p><small>Transkrip ini adalah contoh frontend, bukan hasil speech-to-text aktual.</small></div></div>`:u.inputType===`qr`&&u.qrInputMode===`image`&&u.qrImageDataUrl?`<div class="human-image-context"><img src="${u.qrImageDataUrl}" alt="QR yang sedang diperiksa" /><div><span class="label">QR yang diperiksa</span><strong>${m(u.fileName)}</strong><p>Periksa lokasi QR, pemilik media, serta nama penerima sebelum memindai atau membayar.</p></div></div>`:u.inputType===`qr`?`<div class="human-link-context"><span class="label">Tautan yang diperiksa</span><strong>${m(l(u.content))}</strong><code>${m(u.content)}</code><p>Jangan buka tautan dari panel ini. Nilai klaim pengirim dan cari kanal resmi secara mandiri.</p></div>`:`<div class="message-panel"><span class="label">Informasi yang diperiksa</span><blockquote>${m(u.content||e)}</blockquote></div>`}function A(e,t){return`<div class="confidence-box"><div class="confidence-head"><span>0 - belum yakin</span><span class="confidence-value">${t}% yakin</span></div><input type="range" min="0" max="100" value="${t}" data-range="${e}" aria-label="Tingkat keyakinan ${t} persen" /></div>`}function j(e,t,n,r=``){return`<button class="choice ${t===e?`selected ${r}`:``}" data-select="${n}" data-value="${m(e)}">${m(e)}</button>`}function ee(e,t,n){return`<button class="choice ${t.includes(e)?`selected selected-teal`:``}" data-multi="${n}" data-value="${m(e)}">${m(e)}</button>`}function M(){if(u.hadangStep===-1)return te();let e=[`Jeda`,`Emosi`,`Data`,`Aksi`],t=[u.pressure.length>0,u.emotion.length>0,!!u.evidence,!!u.requestedAction][u.hadangStep];return`<div class="hadang-play-layout fullscreen-play-layout">
    <div class="game-world fullscreen-game-world">
      ${ne()}
      <div class="live-readout"><span class="live-dot"></span><div><small>STATUS ARENA</small><strong data-game-status>${u.gameRoundComplete?`Token tertangkap. Buka pertanyaan ${e[u.hadangStep]}.`:`Gerakkan penjaga ${e[u.hadangStep]} dan tangkap token.`}</strong></div><div class="game-live-stats"><span><small>SKOR</small><b data-game-score>${u.gameScore}</b></span><span><small>NYAWA</small><b data-game-lives>${`&#9829;`.repeat(u.gameLives)}${`&#9825;`.repeat(3-u.gameLives)}</b></span></div></div>
      ${u.questionOpen?`<div class="question-scrim" aria-hidden="true"></div>`:``}
      ${u.questionOpen?`<aside class="game-question-panel game-question-modal ${t?`settled`:`entering`}" id="game-question-panel" role="dialog" aria-modal="false" aria-label="Pertanyaan penjaga ${e[u.hadangStep]}">
        <div class="question-panel-top"><span>POS PENJAGA 0${u.hadangStep+1}</span><span>${u.hadangStep+1} / 4</span><button class="question-close" type="button" data-action="hide-question" aria-label="Tutup pertanyaan" title="Tutup pertanyaan">&times;</button></div>
        ${de()}
      </aside>`:`<button class="question-reopen" type="button" data-action="focus-question"><span>0${u.hadangStep+1}</span><strong>Buka Pertanyaan ${e[u.hadangStep]}</strong></button>`}
    </div>
  </div>`}function te(){return`<div class="transition-panel game-transition game-fullscreen-intro">
    ${N(-1,!0)}
  ...
  </div>`}function ne(){return N(u.hadangStep,!1)}function N(e,t=!1){let n=[[`J`,`JEDA`,22],[`E`,`EMOSI`,40],[`D`,`DATA`,58],[`A`,`AKSI`,76]],r=e<0?0:e,i=t?8:[12,31,49,67][r];return`<div class="hadang-game-stage ${t?`intro-stage`:`arena-stage interactive-arena`}" style="--token-left:${i}%; --player-y:${u.guardY}%" tabindex="${t?`-1`:`0`}" aria-label="Arena Gobak Sodor Hadang Nalar, garis aktif ${n[r][1]}">
    ...
    ${!t&&u.gameOver?`<div class="game-over-panel"><span>MISI GAGAL</span><strong>Tiga informasi lolos.</strong><p>Ulangi ronde dan jaga garis ${n[r][1]}.</p><button class="button button-teal" type="button" data-action="retry-round">Ulangi Ronde</button></div>`:``}
  </div>`}var P=null,re=new Set;function ie(){P&&(cancelAnimationFrame(P.frame),P=null,re.clear())}function ae(){let e=document.querySelector(`.arena-stage.interactive-arena`);!e||u.questionOpen||u.gameRoundComplete||u.gameOver||oe(e)}function oe(e){ie();let t=[22,40,58,76][u.hadangStep],n=[`pesan mendesak`,`tautan palsu`,`QR mencurigakan`,`voice note`,`klaim viral`],r=u.gameCatches+(3-u.gameLives)+u.hadangStep,i=[36,66,43,62,32,57][r%6],a={stage:e,token:e.querySelector(`[data-game-token]`),guard:e.querySelector(`.player-guard`),x:Math.max(6,t-17),y:i,guardY:Math.min(70,Math.max(31,u.guardY)),guardLeft:t,speed:7.3+u.hadangStep*.65,blockingUntil:0,lastTime:performance.now(),frame:0};P=a,a.token?.classList.remove(`caught`,`escaped`),a.guard?.classList.remove(`caught-token`,`is-blocking`);let o=n[r%n.length];a.token?.querySelector(`[data-token-kind]`)?.replaceChildren(o),e.classList.add(`game-running`),e.focus({preventScroll:!0});let s=e=>{if(P!==a||!a.token||!a.guard)return;let t=Math.min((e-a.lastTime)/1e3,.05);a.lastTime=e;let n=(re.has(`arrowdown`)||re.has(`s`)?1:0)-(re.has(`arrowup`)||re.has(`w`)?1:0);a.guardY=Math.min(70,Math.max(31,a.guardY+n*38*t)),a.x+=a.speed*t,a.guard.style.top=`${a.guardY}%`,a.token.style.left=`${a.x}%`,a.token.style.top=`${a.y}%`,a.guard.classList.toggle(`is-blocking`,e<a.blockingUntil);let r=e<a.blockingUntil?14:8,i=Math.abs(a.x-a.guardLeft)<1.25,o=Math.abs(a.y-a.guardY)<r;if(i&&o){F(a);return}if(a.x>a.guardLeft+8){ce(a);return}a.frame=requestAnimationFrame(s)};a.frame=requestAnimationFrame(s)}function se(){P&&(P.blockingUntil=performance.now()+650,P.guard?.classList.add(`is-blocking`))}function F(e){P===e&&(cancelAnimationFrame(e.frame),e.token.classList.add(`caught`),e.guard.classList.add(`caught-token`),u.guardY=e.guardY,u.gameCatches+=1,u.gameScore+=100*u.gameCombo,u.gameCombo=Math.min(4,u.gameCombo+1),u.gameRoundComplete=!0,le(`Token tertangkap di garis ${[`Jeda`,`Emosi`,`Data`,`Aksi`][u.hadangStep]}!`,!0),P=null,setTimeout(()=>{u.questionOpen=!0,y({preserveScroll:!0})},520))}function ce(e){P===e&&(cancelAnimationFrame(e.frame),e.token.classList.add(`escaped`),u.guardY=e.guardY,u.gameLives=Math.max(0,u.gameLives-1),u.gameCombo=1,le(`Informasi lolos. Bersiap untuk token berikutnya.`,!1),P=null,u.gameLives===0?(u.gameOver=!0,setTimeout(()=>y({preserveScroll:!0}),480)):setTimeout(()=>ae(),620))}function le(e,t){let n=document.querySelector(`[data-game-status]`),r=document.querySelector(`[data-game-score]`),i=document.querySelector(`[data-game-lives]`);n&&(n.textContent=e),r&&(r.textContent=u.gameScore),i&&(i.innerHTML=`${`&#9829;`.repeat(u.gameLives)}${`&#9825;`.repeat(3-u.gameLives)}`),document.querySelector(`.live-readout`)?.classList.toggle(`catch-success`,t)}function ue(e=!1){ie(),e&&(u.gameLives=3,u.gameCombo=1),u.gameRoundComplete=!1,u.gameOver=!1,u.questionOpen=!1,u.guardY=54}function de(){let e=a();if(u.hadangStep===0)return`<header><p class="section-kicker">Garis 01 - Jeda</p><h2>Berhenti sejenak dari dorongan bertindak.</h2><p>Apa yang membuat informasi ini terasa harus segera ditindaklanjuti?</p></header>
      <div class="choice-grid compact">${[`Deadline`,`Darurat`,`Ancaman`,`Hadiah`,`Kesempatan terbatas`,`Tekanan sosial`,`Tidak ada tekanan`].map(e=>ee(e,u.pressure,`pressure`)).join(``)}</div>
      ${u.pressure.length?`<div class="insight"><div><strong>Ruang berpikir sedang dipersempit.</strong><br>Tekanan waktu dapat mengurangi ruang untuk mengevaluasi informasi.</div></div>`:``}
      ${fe(`Hadang Garis 1`,u.pressure.length>0)}`;if(u.hadangStep===1)return`<header><p class="section-kicker">Garis 02 - Emosi</p><h2>Kenali emosi yang sedang dipancing.</h2><p>Emosi bukan kesalahan. Mengenalinya membantu kamu menjaga jarak dari tekanan.</p></header>
      <div class="choice-grid compact">${[`Takut`,`Panik`,`Kasihan`,`Percaya`,`Marah`,`FOMO`,`Harapan`,`Penasaran`,`Kedekatan emosional`,`Tidak yakin`].map(e=>ee(e,u.emotion,`emotion`)).join(``)}</div>
      <div class="neutralizer">
        <div class="message-panel"><span class="label">Pesan asli - tekanan aktif</span><blockquote>${m(e.neutralOriginal)}</blockquote></div>
        <div class="message-panel neutral"><span class="label">Tanpa tekanan emosi</span><blockquote>${m(e.neutralVersion)}</blockquote></div>
      </div>
      <div class="question"><span class="question-label">Setelah bahasanya dibuat netral, apakah keputusanmu terasa berbeda?</span><div class="choice-grid compact">${[`Ya`,`Sedikit`,`Tidak`].map(e=>j(e,u.neutralImpact,`neutral-impact`)).join(``)}</div></div>
      ${fe(`Hadang Garis 2`,u.emotion.length>0&&u.neutralImpact)}`;if(u.hadangStep===2){let t=e.evidenceOptions;return`<header><p class="section-kicker">Garis 03 - Data</p><h2>Pisahkan klaim dari buktinya.</h2><p>Bukti yang baik tidak hanya berasal dari pihak yang membuat klaim.</p></header>
      <div class="split-evidence"><section><h4>Klaim</h4><p>${m(e.claim)}</p></section><section><h4>Bukti independen</h4><p>${u.evidence?m(u.evidence):`Belum dipilih`}</p></section></div>
      <div class="question"><span class="question-label">Mana yang paling independen untuk memverifikasi klaim ini?</span><div class="choice-grid">${t.map(e=>j(e,u.evidence,`evidence`)).join(``)}</div></div>
      ${u.evidence?`<div class="insight"><div><strong>${u.evidence===e.preferredEvidence?`Pilihan verifikasi yang kuat.`:`Bukti ini belum cukup independen.`}</strong><br>Bandingkan informasi melalui kanal yang tidak diberikan oleh pesan mencurigakan.</div></div>`:``}
      ${fe(`Hadang Garis 3`,!!u.evidence)}`}let t=e.actionOptions,n=e.riskOptions,r=e.saferOptions;return`<header><p class="section-kicker">Garis 04 - Aksi</p><h2>Lihat tindakan dan konsekuensinya.</h2><p>Pesan manipulatif sering dibuat untuk mempercepat aksi yang sulit dibatalkan.</p></header>
    <div class="question"><span class="question-label">Apa sebenarnya yang diminta informasi ini darimu?</span><div class="choice-grid compact">${t.map(e=>j(e,u.requestedAction,`requested-action`)).join(``)}</div></div>
    <div class="question"><span class="question-label">Apa konsekuensinya jika keputusanmu salah?</span><div class="choice-grid">${n.map(e=>j(e,u.consequence,`consequence`)).join(``)}</div></div>
    <div class="question"><span class="question-label">Apa langkah alternatif yang lebih aman?</span><div class="choice-grid">${r.map(e=>j(e,u.saferAction,`safer-action`)).join(``)}</div></div>
    ${fe(`Hadang Sebelum Bertindak`,u.requestedAction&&u.consequence&&u.saferAction)}`}function fe(e,t){return`<div class="flow-actions"><button class="button button-ghost" data-action="hadang-back">Kembali</button><button class="button button-teal" data-action="hadang-next" ${t?``:`disabled`}>${e}</button></div>`}function pe(t,n){let r=u.content||e,i=u.inputType===`image`&&u.imageDataUrl,a=u.inputType===`audio`&&u.audioDataUrl,o=u.inputType===`qr`,s=n.dataset||(o?{name:u.qrInputMode===`image`?`QR Abuse Reference Set`:`URL Threat Pattern Set`,size:u.qrInputMode===`image`?`42.680 struktur QR`:`1,2 juta snapshot URL`,matches:u.qrInputMode===`image`?`19 pola tujuan serupa`:`63 pola domain serupa`}:null),c=`${_e(n,r)}${n.highlights.map((e,t)=>`<span class="red-box" style="--x:${e.x}%; --y:${e.y}%; --w:${e.w}%; --h:${e.h}%"><b>${t+1}</b></span>`).join(``)}`;return i&&(c=`<div class="xai-image-stage"><img class="xai-source-image" src="${u.imageDataUrl}" alt="Gambar upload dengan penjelasan XAI" />${u.xaiMode===`heatmap`?`<div class="xai-heatmap" aria-hidden="true">${n.highlights.map(e=>`<span style="--hx:${e.x+e.w/2}%; --hy:${e.y+e.h/2}%; --hs:${Math.max(e.w,e.h)*1.7}%"></span>`).join(``)}</div>`:n.highlights.map((e,t)=>`<span class="red-box" style="--x:${e.x}%; --y:${e.y}%; --w:${e.w}%; --h:${e.h}%"><b>${t+1}</b></span>`).join(``)}</div>`),a&&(c=he()),o&&(c=ge()),`<section class="detection-panel" aria-label="Explainable AI detection simulation">
    <div class="detection-header">
      <div><p class="section-kicker">Explainable detection</p><h3>${m(n.title)}</h3><p>${m(n.subtitle)}</p></div>
      <div class="confidence-badge"><span>${m(n.confidenceLabel)}</span><strong>${t.aiScore}%</strong></div>
    </div>
    ${me(i,a,o)}
    <div class="detection-grid">
      <div class="detection-preview ${m(n.mode)}">
        <div class="preview-toolbar"><span></span><span></span><span></span><strong>AI Context Scan</strong></div>
        <div class="preview-canvas ${i?`uploaded-xai ${u.xaiMode}`:``} ${a?`audio-xai ${u.audioXaiMode}`:``} ${o?`qr-xai ${u.qrXaiMode}`:``}">
          ${c}
          ${i?`<div class="xai-legend"><span><i></i>${u.xaiMode===`heatmap`?`Pengaruh tinggi`:`Area perhatian model`}</span><small>Simulasi XAI</small></div>`:``}
        </div>
      ...
      <div class="detection-explain">
        <p class="detection-summary">${m(n.summary)}</p>
        ${s?`<div class="dataset-card"><span>Dataset referensi simulasi</span><strong>${m(s.name)}</strong><div><small>${m(s.size)}</small><small>${m(s.matches)}</small></div><p>Statistik dibuat untuk demonstrasi UI dan bukan hasil model produksi.</p></div>`:``}
        <div class="highlight-list">
          ${n.highlights.map((e,t)=>`<article><span>${t+1}</span><div><h4>${m(e.label)}${e.start?`<small>${m(e.start)}-${m(e.end)}</small>`:``}</h4><p>${m(e.detail)}</p></div></article>`).join(``)}
        </div>
      </div>
    </div>
    <div class="clue-question-grid">
      <section class="info-panel clue-panel"><h3>Clue yang terlihat</h3><ul>${n.clues.map(e=>`<li>${m(e)}</li>`).join(``)}</ul></section>
      <section class="info-panel question-panel"><h3>Pertanyaan reflektif</h3><ul>${n.reflectiveQuestions.map(e=>`<li>${m(e)}</li>`).join(``)}</ul></section>
    </div>
  </section>`}function me(e,t,n){return e?`<div class="xai-mode-bar"><div><strong>Visual Penjelasan XAI</strong><span>Pilih cara model menampilkan area yang memengaruhi sinyal.</span></div><div class="xai-segmented" role="group" aria-label="Mode visual XAI"><button class="${u.xaiMode===`bounding`?`active`:``}" type="button" data-xai-mode="bounding">Bounding Box</button><button class="${u.xaiMode===`heatmap`?`active`:``}" type="button" data-xai-mode="heatmap">Heatmap</button></div></div>`:t?`<div class="xai-mode-bar"><div><strong>Penjelasan Pola Audio</strong><span>Bandingkan sinyal suara dan distribusi frekuensi simulatif.</span></div><div class="xai-segmented" role="group" aria-label="Mode analisis audio"><button class="${u.audioXaiMode===`voice`?`active`:``}" type="button" data-audio-xai-mode="voice">Voice Pattern</button><button class="${u.audioXaiMode===`spectrogram`?`active`:``}" type="button" data-audio-xai-mode="spectrogram">Spectrogram</button></div></div>`:n?`<div class="xai-mode-bar"><div><strong>Penjelasan Risiko Tujuan</strong><span>Lihat sinyal struktur dan jalur yang mungkin dilalui.</span></div><div class="xai-segmented" role="group" aria-label="Mode analisis QR atau tautan"><button class="${u.qrXaiMode===`risk`?`active`:``}" type="button" data-qr-xai-mode="risk">Risk Map</button><button class="${u.qrXaiMode===`redirect`?`active`:``}" type="button" data-qr-xai-mode="redirect">Redirect Chain</button></div></div>`:``}function he(){return`<div class="audio-analysis-stage"><div class="audio-analysis-meta"><span>VOICE SAMPLE / 00:18</span><b>${u.audioXaiMode===`voice`?`Pola suara`:`Spektrum frekuensi`}</b></div><div class="${u.audioXaiMode===`spectrogram`?`spectrogram-panel`:`voice-pattern-panel`}">${T(58,`analysis-wave`)}<span class="audio-marker marker-one">1</span><span class="audio-marker marker-two">2</span><span class="audio-marker marker-three">3</span></div><div class="audio-time-axis"><span>00:00</span><span>00:06</span><span>00:12</span><span>00:18</span></div><audio controls preload="metadata" src="${u.audioDataUrl}"></audio><div class="ai-transcript"><span>Transkrip simulasi</span><p>Nak, ini Mama. Nomor Mama bermasalah. <mark>Tolong transfer sekarang</mark> dan <mark>jangan telepon dulu</mark>.</p></div></div>`}function ge(){let e=u.qrInputMode===`image`&&u.qrImageDataUrl;if(u.qrXaiMode===`redirect`)return`<div class="redirect-analysis"><span class="analysis-label">SIMULATED REDIRECT TRACE</span><div class="redirect-chain"><div><i>1</i><span>Input pengguna<small>${e?`QR image decode`:m(l(u.content))}</small></span></div><b></b><div class="warn"><i>2</i><span>Short redirect<small>tracking-gateway.example</small></span></div><b></b><div class="danger"><i>3</i><span>Form kredensial<small>secure-login-check.example</small></span></div></div><p>Rantai ini adalah visualisasi dataset simulasi. HADANGIN tidak membuka alamat tersebut.</p></div>`;if(e)return`<div class="qr-image-analysis"><img src="${u.qrImageDataUrl}" alt="QR upload dalam pemetaan risiko" /><span class="qr-scan-line"></span><span class="qr-focus focus-a">1</span><span class="qr-focus focus-b">2</span></div><div class="qr-destination"><span>Tujuan terbaca / simulasi</span><strong>pay-verify.example</strong><small>Penerima belum dapat dikonfirmasi</small></div>`;let t=l(u.content);return`<div class="url-risk-analysis"><span class="analysis-label">URL TOKEN RISK MAP</span><div class="url-token-map">${u.content.replace(/^https?:\/\//i,``).split(/([./?=&-])/).filter(Boolean).slice(0,18).map((e,t)=>`<span class="${t===0||/login|verify|secure|otp/i.test(e)?`flagged`:``}">${m(e)}</span>`).join(``)}</div><div class="domain-facts"><div><span>Host terbaca</span><strong>${m(t)}</strong></div><div><span>Pola terdeteksi</span><strong>Login + urgency</strong></div><div><span>Status</span><strong>Perlu verifikasi</strong></div></div></div>`}function _e(e,t){return e.mode===`qr`?`<div class="qr-preview"><span></span><span></span><span></span><i></i></div><div class="preview-caption">QR baru di area pembayaran</div>`:e.mode===`media`?`<div class="media-preview"><span class="media-face"></span><span class="media-body"></span><i></i><em></em></div><div class="preview-caption">Frame video / gambar yang dianalisis</div>`:e.mode===`link`?`<div class="link-preview"><strong>Bank Alert</strong><p>Rekening Anda akan diblokir dalam 30 menit.</p><code>https://secure-verifikasi.example/login</code></div>`:e.mode===`official`?`<div class="official-preview"><strong>Pemberitahuan Resmi</strong><p>${m(t)}</p><span>Perlu dicocokkan dengan aplikasi resmi.</span></div>`:`<div class="message-preview"><p>${m(t)}</p></div>`}function ve(){let e=s(),t=c(),n=[[`J`,`Jeda`,e.aiNotices[0]?.[1]||`Tekanan perlu diperiksa`,Math.min(96,e.aiScore+6),`amber`],[`E`,`Emosi`,e.aiNotices[1]?.[1]||`Respons emosional terdeteksi`,Math.max(42,e.aiScore-9),`red`],[`D`,`Data`,e.aiNotices[2]?.[1]||`Bukti belum terkonfirmasi`,Math.max(48,e.aiScore-4),`blue`],[`A`,`Aksi`,e.aiNotices[3]?.[1]||`Tindakan berisiko terdeteksi`,Math.min(98,e.aiScore+3),`teal`]],r=e.aiScore>=80?`Risiko tinggi - verifikasi sebelum bertindak`:e.aiScore>=70?`Perlu verifikasi lebih lanjut`:`Sinyal sedang - periksa bukti resmi`;return`<section class="direct-detection-page"><div class="page-shell">
    ...
    <header class="direct-result-header"><div><p class="section-kicker">Hasil prediksi langsung</p><h1>AI menghadang empat sinyal sebelum tindakan.</h1><p>Hasil ini melewati latihan Human First dan game. Gunakan penjelasan XAI untuk menentukan apa yang masih perlu diverifikasi.</p></div><div class="direct-verdict"><span>${m(t.confidenceLabel)}</span><strong>${e.aiScore}%</strong><p>${m(r)}</p></div></header>
    <section class="ai-court-board" aria-label="Papan sinyal J.E.D.A. hasil prediksi AI"><div class="court-entry"><span>INPUT</span><i></i></div><div class="court-track">${n.map(([e,t,n,r,i],a)=>`<article class="court-signal ${i}"><div class="court-line"></div><span class="court-letter">${e}</span><div><small>GARIS 0${a+1}</small><strong>${t}</strong><p>${m(n)}</p><div class="court-score"><i style="--score:${r}%"></i><b>${r}</b></div></div></article>`).join(``)}</div><div class="court-gate"><span>AKSI</span><strong>${e.aiScore>=80?`TAHAN`:`CEK`}</strong></div></section>
    ${pe(e,t)}
    <div class="ai-notice-grid">${e.aiNotices.map(([e,t])=>`<div class="signal-card"><small>${m(e)}</small><strong>${m(t)}</strong></div>`).join(``)}</div>
    <div class="ai-columns direct-ai-columns"><section class="info-panel unknown"><h3>Yang belum dapat dipastikan AI</h3><ul>${e.unknowns.map(e=>`<li>${m(e)}</li>`).join(``)}</ul></section><section class="info-panel verify"><h3>Langkah verifikasi berikutnya</h3><ul>${e.verification.map(e=>`<li>${m(e)}</li>`).join(``)}</ul></section></div>
  ...
  </div></section>`}function ye(){let e=s();return`<div class="flow-card">
    ...
    ${pe(e,c())}
    <div class="ai-notice-grid">${e.aiNotices.map(([e,t])=>`<div class="signal-card"><small>${m(e)}</small><strong>${m(t)}</strong></div>`).join(``)}</div>
    <div class="forensic-meter"><div class="forensic-meter-head"><strong>${u.aiWrong?`Suspicious Signals`:`Manipulation Signals`}: ${e.aiLevel}</strong><span>${e.aiScore}% indikator model</span></div><div class="meter"><span style="width:${e.aiScore}%"></span></div><p>Nilai ini menunjukkan sinyal model, bukan kebenaran final. Gunakan hasil ini untuk menentukan apa yang perlu dicek, bukan untuk langsung percaya.</p></div>
    <div class="ai-columns">
      <section class="info-panel unknown"><h3>Yang belum dapat dipastikan AI</h3><ul>${e.unknowns.map(e=>`<li>${m(e)}</li>`).join(``)}</ul></section>
      <section class="info-panel verify"><h3>Yang dapat kamu verifikasi</h3><ul>${e.verification.map(e=>`<li>${m(e)}</li>`).join(``)}</ul></section>
    </div>
  ...
  </div>`}function be(){let e=s(),t=u.aiWrong?[`Saya setuju dengan AI`,`Saya tidak setuju dengan AI`,`Verifikasi lagi`,`Belum yakin`]:[`Lanjut`,`Verifikasi Dulu`,`Berhenti`,`Belum Yakin`];return`<div class="flow-card">
    ...
    <div class="comparison"><div><span class="comparison-label">Penilaian awal saya</span><strong>${m(u.initialDecision)}</strong><p>Confidence: ${u.initialConfidence}%</p></div><div><span class="comparison-label">AI Lens</span><strong>${u.aiWrong?`Suspicious`:`Manipulation`} Signals: ${e.aiScore}%</strong><p>${m(e.aiNotices.slice(2).map(([e,t])=>`${e}: ${t}`).join(` · `))}</p></div></div>
    <div class="question"><span class="question-label">Setelah melihat bukti dan AI Lens, apa keputusanmu sekarang?</span><div class="choice-grid">${t.map(e=>j(e,u.finalDecision,`final-decision`)).join(``)}</div></div>
    <div class="question"><span class="question-label">Seberapa yakin kamu dengan keputusan final itu?</span>${A(`final-confidence`,u.finalConfidence)}</div>
    <div class="flow-actions"><button class="button button-ghost" data-action="back-to-ai">Kembali</button><button class="button button-teal" data-action="lock-final" ${u.finalDecision?``:`disabled`}>Kunci Keputusan Akhir</button></div>
  </div>`}function xe(){return`<div class="flow-card">
    ...
    <div class="question"><div class="question-label">Pilih paling banyak dua faktor. <span class="max-note">${u.reflection.length}/2 dipilih</span></div><div class="choice-grid compact">${[`Bukti / sumber`,`Emosi`,`Tekanan waktu`,`Risiko tindakan`,`Analisis AI`,`Verifikasi independen`,`Tidak berubah`].map(e=>ee(e,u.reflection,`reflection`)).join(``)}</div></div>
    <div class="question"><span class="question-label">Jika AI bertentangan dengan bukti independen, mana yang seharusnya kamu prioritaskan?</span><div class="choice-grid">${[`AI`,`Bukti independen`,`Opini viral`,`Kanal resmi`,`Belum yakin`].map(e=>j(e,u.priority,`priority`)).join(``)}</div></div>
    ${u.priority&&![`Bukti independen`,`Kanal resmi`].includes(u.priority)?`<div class="insight"><div><strong>Berhenti sejenak.</strong><br>Pertimbangkan kembali sumber mana yang dapat diverifikasi secara independen.</div></div>`:``}
    <div class="flow-actions"><button class="button button-ghost" data-action="back-to-final">Kembali</button><button class="button button-teal" data-action="show-result" ${u.reflection.length&&u.priority?``:`disabled`}>Lihat Snapshot Nalar</button></div>
  </div>`}function I(){let e=s(),t=[`Verifikasi Dulu`,`Berhenti`,`Saya tidak setuju dengan AI`,`Verifikasi lagi`].includes(u.finalDecision),n=[[`Mengenali tekanan`,u.pressure.length>1?88:76],[`Kesadaran emosi`,u.emotion.length>1?84:72],[`Pemeriksaan bukti`,u.evidence===e.preferredEvidence?92:70],[`Kesadaran risiko aksi`,u.saferAction?86:68]];return`<div class="flow-card">
    <header><p class="section-kicker">Critical Thinking Snapshot</p><h2>${u.aiWrong&&u.finalDecision===`Saya tidak setuju dengan AI`?`Penilaian baik. AI bukan otoritas final.`:`Pemeriksaan selesai.`}</h2><p>${t?`Kamu memberi ruang bagi bukti baru sebelum menentukan tindakan.`:`Snapshot ini menunjukkan area yang bisa diperkuat pada pemeriksaan berikutnya.`}</p></header>
    ...
    <div class="before-after"><div class="snapshot-box"><small>Sebelum</small><strong>${m(u.initialDecision)} - ${u.initialConfidence}% yakin</strong></div><span class="arrow" aria-hidden="true">&#8594;</span><div class="snapshot-box after"><small>Sesudah</small><strong>${m(u.finalDecision)} - ${u.finalConfidence}% yakin</strong></div></div>
    ...
    <section class="section dashboard-section"><div class="page-shell">
      ...
      <div class="metric-grid">${Se.summary.map(([e,t,n])=>`<article class="metric-card"><span>${m(e)}</span><strong>${m(t)}</strong><p>${m(n)}</p></article>`).join(``)}</div>
      <div class="dashboard-grid two">
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">Before vs after</p><h2>Perubahan keputusan pengguna</h2><p>Dari respons reaktif menuju verifikasi atau berhenti sebelum share.</p></div><div class="judgment-compare"><section><h3>Sebelum J.E.D.A.</h3>${Se.before.map(e=>L(e,`before`)).join(``)}</section><section><h3>Sesudah AI Lens</h3>${Se.after.map(e=>L(e,`after`)).join(``)}</section></div></article>
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">Pattern map</p><h2>Pola manipulasi dominan</h2><p>Insight untuk educator, komunitas, dan peneliti MIL.</p></div><div class="pattern-list">${Se.patterns.map(([e,t])=>L([e,t],`pattern`)).join(``)}</div></article>
      </div>
      <div class="dashboard-grid two compact">
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">Multimodal input</p><h2>Jenis konten diperiksa</h2></div><div class="media-donut" aria-label="Distribusi tipe media"><span>46%</span></div><div class="media-list">${Se.media.map(([e,t])=>`<p><i style="--dot:${t}%"></i><span>${m(e)}</span><b>${t}%</b></p>`).join(``)}</div></article>
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">J.E.D.A. growth</p><h2>Skill literasi yang terbentuk</h2></div><div class="skill-list dashboard-skills">${Se.jeda.map(([e,t,n])=>`<div class="skill-row"><span>${m(e)}<small>${m(n)}</small></span><div class="skill-bar"><i style="width:${t}%"></i></div><b>${t}</b></div>`).join(``)}</div></article>
      </div>
      <div class="dashboard-grid two compact">
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">Explainability engagement</p><h2>Apakah pengguna belajar dari clue?</h2></div><div class="explain-grid">${Se.explainability.map(([e,t])=>`<div><strong>${t}%</strong><span>${m(e)}</span></div>`).join(``)}</div></article>
    ...
    <section class="section training-arena-section" id="training-arenas"><div class="page-shell">
      ...
      <div class="scenario-grid">${n.map(e=>`<article class="scenario-card ${e.featured?`featured`:``}" data-scenario-card="${e.id}"><span class="scenario-no">${e.no}</span><h3>${e.title}</h3><p>${e.description}</p><div class="chip-row">${e.triggers.map(t=>`<span class="chip ${e.featured?`chip-terra`:``}">${t}</span>`).join(``)}</div><button class="button ${e.featured?``:`button-secondary`}" data-scenario="${e.id}">Mulai Skenario</button></article>`).join(``)}</div>
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(e,t,n){let r=new Float32Array(Ds),i=new q(0,1,0);return new io({name:`SphericalGaussianBlur`,defines:{n:Ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(){return new io({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Us(){return new io({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ws(),fragmentShader:`
	...
	`}var Gs=class extends or{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ba(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
