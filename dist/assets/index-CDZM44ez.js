(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`Nak, Mama kecelakaan. HP Mama rusak. Transfer Rp3 juta sekarang ke rekening ini. Tolong cepat, ya!`,t=new URL(`/assets/tolong_buatkan_video_songnya-B60BK3da.mp4`,``+import.meta.url).href,n=[{id:`family-emergency`,no:`01`,title:`Pesan Keluarga Darurat`,description:`Nomor baru mengaku sebagai keluarga dan meminta transfer segera.`,triggers:[`Urgency`,`Fear`,`Attachment`],inputType:`text`,format:`Teks / Pesan`,source:`Pesan WhatsApp dari nomor baru`,mission:`Pastikan identitas pengirim sebelum merespons permintaan transfer.`,content:e,featured:!0},{id:`qr-payment`,no:`02`,title:`QR Pembayaran`,description:`QR pengganti ditempel di atas kode pembayaran resmi sebuah merchant.`,triggers:[`Trust`,`Habit`,`Convenience`],inputType:`qr`,inputMode:`image`,format:`Gambar QR`,source:`Foto QR di meja kasir`,mission:`Periksa pemilik QR dan nama penerima sebelum pembayaran diproses.`,content:`QR di meja kasir sedang bermasalah. Scan kode baru ini agar pembayaran langsung diproses.`},{id:`job-offer`,no:`03`,title:`Lowongan Kerja`,description:`Tawaran kerja bergaji tinggi meminta deposit untuk proses administrasi.`,triggers:[`Hope`,`Authority`,`Scarcity`],inputType:`image`,format:`Screenshot`,source:`Poster lowongan dari grup percakapan`,mission:`Bedakan tampilan profesional dari bukti rekrutmen yang dapat diverifikasi.`,content:`Selamat, Anda lolos seleksi awal. Transfer biaya administrasi hari ini untuk mengamankan posisi.`},{id:`bank-message`,no:`04`,title:`Pesan Bank`,description:`Pesan mengancam pemblokiran rekening dan mengarahkan ke sebuah tautan.`,triggers:[`Fear`,`Authority`,`Urgency`],inputType:`qr`,inputMode:`link`,format:`Tautan`,source:`SMS mengatasnamakan bank`,mission:`Baca struktur alamat tanpa membuka tautan dan cocokkan dengan kanal bank resmi.`,content:`Rekening Anda akan diblokir dalam 30 menit. Klik tautan ini untuk verifikasi identitas.`,payload:`https://secure-verifikasi-akun.example/login?session=30min`},{id:`viral-info`,no:`05`,title:`Informasi Viral`,description:`Unggahan emosional mendorong pengguna menyebarkan klaim tanpa sumber.`,triggers:[`Anger`,`Social Pressure`],inputType:`image`,format:`Screenshot`,source:`Tangkapan layar unggahan viral`,mission:`Temukan sumber primer, tanggal, dan konteks sebelum membagikan ulang.`,content:`Mereka tidak ingin kamu tahu fakta ini. Sebarkan sekarang sebelum unggahan dihapus!`},{id:`manipulated-media`,no:`06`,title:`Media Manipulatif`,description:`Video tokoh publik tampak nyata, tetapi konteks dan sumbernya tidak jelas.`,triggers:[`Realism`,`Authority`],inputType:`image`,format:`Frame Video`,source:`Potongan video dari akun tidak dikenal`,mission:`Periksa sinkronisasi visual, sumber asli, dan legalitas ajakan investasi.`,content:`Video eksklusif tokoh publik membagikan peluang investasi yang hanya tersedia hari ini.`},{id:`ai-can-be-wrong`,no:`07`,title:`AI Bisa Salah`,description:`Bukti resmi dapat lebih kuat daripada sinyal AI. Latih keberanian untuk tidak setuju.`,triggers:[`Automation Bias`],inputType:`text`,format:`Notifikasi Resmi`,source:`Pemberitahuan dalam aplikasi layanan`,mission:`Bandingkan skor AI dengan bukti resmi dan kenali kemungkinan false positive.`,content:`Pemberitahuan resmi: jadwal layanan berubah. Periksa pembaruan pada aplikasi resmi.`,aiWrong:!0},{id:`audio-impersonation`,no:`08`,title:`Voice Note Keluarga`,description:`Rekaman suara mirip anggota keluarga meminta transfer dan melarang kamu menelepon.`,triggers:[`Voice Clone`,`Urgency`,`Fear`],inputType:`audio`,format:`Voice Note`,source:`Rekaman 18 detik dari nomor baru`,mission:`Nilai pola suara, isi permintaan, dan lakukan konfirmasi melalui kanal lain.`,content:`Nak, ini Mama. Nomor Mama sedang bermasalah. Tolong transfer sekarang dan jangan telepon dulu.`}],r={"family-emergency":{neutralOriginal:`MAMA KECELAKAAN! TRANSFER SEKARANG!`,neutralVersion:`Seseorang meminta kamu mentransfer Rp3.000.000.`,claim:`Pengirim mengaku sebagai ibu dan sedang mengalami keadaan darurat.`,evidenceOptions:[`Foto dari nomor tersebut`,`Voice note dari nomor tersebut`,`Nomor rekening yang diberikan`,`Telepon nomor ibu yang tersimpan`],preferredEvidence:`Telepon nomor ibu yang tersimpan`,actionOptions:[`Transfer`,`Klik`,`Berikan OTP`,`Share`],riskOptions:[`Kehilangan uang`,`Akun diambil alih`,`Data pribadi bocor`,`Misinformasi menyebar`],saferOptions:[`Telepon nomor tersimpan`,`Buka aplikasi resmi sendiri`,`Cari sumber independen`,`Tunggu dan cek ulang`],aiNotices:[[`Pressure`,`“sekarang”, “tolong cepat”`],[`Emotion`,`Emergency framing`],[`Identity`,`Identitas belum terkonfirmasi`],[`Requested action`,`Transfer segera`]],aiLevel:`High`,aiScore:82,unknowns:[`Identitas asli pengirim.`,`Apakah keadaan darurat benar terjadi.`,`Konteks lengkap di luar pesan ini.`,`Apakah model salah membaca sinyal.`],verification:[`Hubungi nomor keluarga yang tersimpan.`,`Periksa penerima sebelum pembayaran.`,`Tanya anggota keluarga lain.`,`Gunakan kanal di luar pesan ini.`]},"qr-payment":{neutralOriginal:`QR LAMA RUSAK. SCAN YANG BARU SEKARANG!`,neutralVersion:`Sebuah kode QR baru meminta kamu melakukan pembayaran.`,claim:`Kode QR baru diklaim sebagai kanal pembayaran resmi merchant.`,evidenceOptions:[`Logo merchant pada stiker`,`Warna QR yang terlihat resmi`,`Konfirmasi langsung kepada kasir`,`Jumlah orang yang sudah memindai`],preferredEvidence:`Konfirmasi langsung kepada kasir`,actionOptions:[`Scan`,`Transfer`,`Download`,`Berikan OTP`],riskOptions:[`Pembayaran masuk ke pihak salah`,`Data rekening bocor`,`Perangkat terinfeksi`,`Saldo tertahan`],saferOptions:[`Konfirmasi QR kepada kasir`,`Periksa nama penerima`,`Gunakan mesin pembayaran resmi`,`Batalkan dan cek ulang`],aiNotices:[[`Pressure`,`Dorongan menyelesaikan antrean`],[`Habit`,`Scan tanpa memeriksa penerima`],[`Identity`,`Pemilik QR belum terkonfirmasi`],[`Requested action`,`Pembayaran melalui QR baru`]],aiLevel:`Medium`,aiScore:74,unknowns:[`Siapa pemilik rekening tujuan.`,`Apakah QR benar diganti merchant.`,`Kondisi stiker sebelum difoto.`,`Apakah deteksi visual melewatkan perubahan.`],verification:[`Tanyakan QR resmi kepada kasir.`,`Periksa nama penerima sebelum membayar.`,`Bandingkan dengan QR di kasir utama.`,`Simpan bukti transaksi.`]},"job-offer":{neutralOriginal:`POSISI TERBATAS! BAYAR DEPOSIT HARI INI!`,neutralVersion:`Pihak yang menawarkan pekerjaan meminta biaya administrasi.`,claim:`Pengirim mengaku mewakili perusahaan dan menjanjikan posisi kerja.`,evidenceOptions:[`Testimoni di pesan`,`Logo perusahaan`,`Kontak HR pada situs resmi perusahaan`,`Screenshot slip gaji`],preferredEvidence:`Kontak HR pada situs resmi perusahaan`,actionOptions:[`Transfer`,`Kirim data pribadi`,`Download`,`Klik`],riskOptions:[`Kehilangan uang`,`Identitas disalahgunakan`,`Perangkat terinfeksi`,`Akun diambil alih`],saferOptions:[`Hubungi HR melalui situs resmi`,`Cari lowongan di kanal perusahaan`,`Tolak biaya di muka`,`Periksa legalitas perusahaan`],aiNotices:[[`Pressure`,`Posisi disebut terbatas`],[`Emotion`,`Harapan mendapat pekerjaan`],[`Authority`,`Mengatasnamakan perusahaan`],[`Requested action`,`Deposit administrasi`]],aiLevel:`High`,aiScore:88,unknowns:[`Hubungan pengirim dengan perusahaan.`,`Apakah posisi tersebut benar tersedia.`,`Keaslian dokumen yang dilampirkan.`,`Kebijakan rekrutmen perusahaan.`],verification:[`Cari lowongan pada situs resmi.`,`Hubungi HR melalui kontak independen.`,`Periksa domain email pengirim.`,`Jangan membayar biaya rekrutmen di muka.`]},"bank-message":{neutralOriginal:`REKENING DIBLOKIR 30 MENIT LAGI. KLIK!`,neutralVersion:`Sebuah pesan meminta verifikasi rekening melalui tautan.`,claim:`Pengirim mengaku sebagai bank dan menyatakan rekening akan diblokir.`,evidenceOptions:[`Logo bank di pesan`,`Nomor pengirim terlihat rapi`,`Notifikasi di aplikasi bank resmi`,`Tautan yang dikirim`],preferredEvidence:`Notifikasi di aplikasi bank resmi`,actionOptions:[`Klik`,`Berikan OTP`,`Download`,`Kirim data pribadi`],riskOptions:[`Akun diambil alih`,`Kehilangan uang`,`Data pribadi bocor`,`Perangkat terinfeksi`],saferOptions:[`Buka aplikasi bank sendiri`,`Hubungi nomor di kartu`,`Ketik alamat resmi secara manual`,`Tunggu dan cek notifikasi resmi`],aiNotices:[[`Pressure`,`Ancaman blokir dalam 30 menit`],[`Authority`,`Mengatasnamakan bank`],[`Link`,`Domain tujuan perlu diperiksa`],[`Requested action`,`Verifikasi identitas`]],aiLevel:`High`,aiScore:91,unknowns:[`Status rekening sebenarnya.`,`Pemilik domain tujuan.`,`Apakah bank mengirim pemberitahuan lain.`,`Identitas operator pesan.`],verification:[`Buka aplikasi bank tanpa memakai tautan.`,`Hubungi nomor resmi pada kartu.`,`Periksa domain di situs resmi bank.`,`Jangan pernah membagikan OTP.`]},"viral-info":{neutralOriginal:`SEBARKAN SEBELUM DIHAPUS! MEREKA MENUTUPI FAKTA!`,neutralVersion:`Sebuah unggahan membuat klaim tanpa menyertakan sumber yang jelas.`,claim:`Unggahan mengklaim informasi penting sedang sengaja disembunyikan.`,evidenceOptions:[`Jumlah share`,`Komentar yang setuju`,`Sumber primer dan laporan independen`,`Akun yang pertama mengirim`],preferredEvidence:`Sumber primer dan laporan independen`,actionOptions:[`Share`,`Klik`,`Download`,`Kirim data pribadi`],riskOptions:[`Misinformasi menyebar`,`Reputasi pihak dirugikan`,`Konflik meningkat`,`Data pribadi bocor`],saferOptions:[`Cari sumber primer`,`Baca laporan dari beberapa sumber`,`Periksa tanggal dan konteks`,`Tunda membagikan`],aiNotices:[[`Pressure`,`Dorongan menyebarkan segera`],[`Emotion`,`Kemarahan dan rasa curiga`],[`Source`,`Sumber primer tidak terlihat`],[`Requested action`,`Membagikan ulang`]],aiLevel:`Medium`,aiScore:77,unknowns:[`Asal klaim pertama.`,`Konteks kejadian lengkap.`,`Apakah materi sudah dipotong.`,`Motif akun yang menyebarkan.`],verification:[`Cari sumber primer.`,`Bandingkan laporan independen.`,`Periksa tanggal, lokasi, dan konteks.`,`Jangan jadikan viralitas sebagai bukti.`]},"manipulated-media":{neutralOriginal:`VIDEO ASLI! INVESTASI INI HANYA HARI INI!`,neutralVersion:`Sebuah video tokoh publik mempromosikan peluang investasi.`,claim:`Video diklaim menampilkan tokoh publik yang mendukung sebuah investasi.`,evidenceOptions:[`Wajah terlihat realistis`,`Banyak komentar positif`,`Pernyataan pada kanal resmi tokoh`,`Kualitas video tinggi`],preferredEvidence:`Pernyataan pada kanal resmi tokoh`,actionOptions:[`Investasi / pembelian`,`Klik`,`Transfer`,`Share`],riskOptions:[`Kehilangan uang`,`Misinformasi menyebar`,`Identitas disalahgunakan`,`Akun diambil alih`],saferOptions:[`Periksa kanal resmi tokoh`,`Cari unggahan asli`,`Periksa izin lembaga terkait`,`Tunda keputusan investasi`],aiNotices:[[`Visual`,`Sinkronisasi wajah perlu ditinjau`],[`Audio`,`Pola suara tampak tidak konsisten`],[`Context`,`Sumber unggahan tidak jelas`],[`Requested action`,`Investasi segera`]],aiLevel:`High`,aiScore:84,unknowns:[`Siapa pembuat video.`,`Apakah cuplikan sudah disunting.`,`Konteks rekaman asli.`,`Legalitas produk investasi.`],verification:[`Cari video pada kanal resmi tokoh.`,`Gunakan pencarian balik frame.`,`Periksa izin produk investasi.`,`Jangan bertindak hanya dari kemiripan visual.`]},"audio-impersonation":{neutralOriginal:`NAK, INI MAMA. TOLONG TRANSFER SEKARANG, JANGAN TELEPON DULU!`,neutralVersion:`Seseorang dalam rekaman suara meminta kamu mentransfer uang.`,claim:`Pembicara mengaku sebagai anggota keluarga dan sedang mengalami keadaan darurat.`,evidenceOptions:[`Suara terdengar mirip`,`Nomor pengirim memakai foto keluarga`,`Telepon nomor keluarga yang tersimpan`,`Rekaman menyebut nama panggilan`],preferredEvidence:`Telepon nomor keluarga yang tersimpan`,actionOptions:[`Transfer`,`Kirim voice note balasan`,`Berikan OTP`,`Teruskan rekaman`],riskOptions:[`Kehilangan uang`,`Identitas suara disalahgunakan`,`Akun diambil alih`,`Kepanikan menyebar`],saferOptions:[`Telepon nomor tersimpan`,`Ajukan pertanyaan rahasia keluarga`,`Konfirmasi ke anggota keluarga lain`,`Tunda transfer`],aiNotices:[[`Voice pattern`,`Pola prosodi tidak konsisten`],[`Urgency`,`Transfer diminta segera`],[`Identity`,`Kemiripan suara bukan bukti identitas`],[`Audio trace`,`Jejak kompresi terdeteksi`]],aiLevel:`High`,aiScore:81,unknowns:[`Identitas asli pembicara.`,`Apakah suara sintetis atau rekaman asli yang terkompresi.`,`Konteks sebelum dan sesudah potongan audio.`,`Apakah pola suara kebetulan mirip data referensi.`],verification:[`Telepon nomor keluarga yang sudah tersimpan.`,`Gunakan pertanyaan yang hanya diketahui keluarga.`,`Konfirmasi kepada anggota keluarga lain.`,`Jangan transfer berdasarkan kemiripan suara.`]},"ai-can-be-wrong":{neutralOriginal:`PEMBERITAHUAN RESMI: JADWAL LAYANAN BERUBAH.`,neutralVersion:`Sebuah layanan menginformasikan perubahan jadwal.`,claim:`Pemberitahuan menyatakan jadwal layanan resmi telah berubah.`,evidenceOptions:[`AI menandainya mencurigakan`,`Tampilan pesannya formal`,`Pembaruan yang sama di aplikasi resmi`,`Pendapat di media sosial`],preferredEvidence:`Pembaruan yang sama di aplikasi resmi`,actionOptions:[`Buka aplikasi resmi`,`Share`,`Klik`,`Download`],riskOptions:[`Salah memahami jadwal`,`Membagikan informasi usang`,`Mengabaikan pengumuman sah`,`Tidak ada risiko besar`],saferOptions:[`Cocokkan dengan aplikasi resmi`,`Hubungi layanan resmi`,`Periksa waktu publikasi`,`Gunakan kanal resmi lain`],aiNotices:[[`Language`,`Bahasa formal terdeteksi`],[`Pattern`,`Format mirip pesan massal`],[`Identity`,`Pengirim tampak resmi`],[`Requested action`,`Buka aplikasi resmi`]],aiLevel:`Medium`,aiScore:68,unknowns:[`AI tidak mengakses akun layananmu.`,`Model belum melihat bukti di aplikasi resmi.`,`Format resmi dapat menyerupai pesan palsu.`,`Sinyal model dapat menjadi false positive.`],verification:[`Cocokkan isi di aplikasi resmi.`,`Periksa pengirim pada kanal resmi.`,`Prioritaskan bukti yang dapat diverifikasi.`,`Tidak perlu mengikuti AI jika bukti lebih kuat.`]}},i={"family-emergency":{mode:`message`,title:`Pesan darurat keluarga`,subtitle:`Simulasi analisis teks WhatsApp`,summary:`Model menemukan tekanan aksi cepat, identitas belum terverifikasi, dan permintaan transfer yang sulit dibatalkan.`,confidenceLabel:`Manipulation likelihood`,highlights:[{label:`Urgency`,detail:`'sekarang' dan 'tolong cepat' mempersempit ruang berpikir.`,x:12,y:20,w:44,h:18},{label:`Identity gap`,detail:`Nomor baru mengaku keluarga tanpa bukti independen.`,x:36,y:44,w:48,h:18},{label:`Risky action`,detail:`Permintaan transfer muncul sebelum identitas dikonfirmasi.`,x:18,y:69,w:58,h:16}],clues:[`Tekanan waktu tinggi`,`Identitas pengirim belum dikonfirmasi`,`Aksi finansial diminta di awal`,`Kanal verifikasi independen tersedia`],reflectiveQuestions:[`Apakah kamu sudah menelepon nomor keluarga yang tersimpan?`,`Apa risiko jika transfer dilakukan sebelum konfirmasi?`,`Siapa sumber lain yang bisa mengonfirmasi keadaan darurat ini?`]},"qr-payment":{mode:`qr`,title:`QR pembayaran mencurigakan`,subtitle:`Simulasi analisis QR/link`,summary:`Model menandai kemungkinan QR pengganti, tetapi penerima pembayaran tetap harus diverifikasi langsung kepada merchant.`,confidenceLabel:`QR risk signal`,highlights:[{label:`Overlay`,detail:`Area stiker tampak seperti lapisan baru di atas permukaan lama.`,x:21,y:24,w:56,h:44},{label:`Recipient unknown`,detail:`Pemilik rekening tujuan belum terlihat sebelum pembayaran.`,x:18,y:73,w:64,h:14}],clues:[`QR baru menggantikan kanal lama`,`Penerima dana belum terlihat`,`Konteks kasir perlu dicek langsung`,`Pembayaran adalah aksi sulit dibatalkan`],reflectiveQuestions:[`Apakah nama penerima cocok dengan merchant?`,`Apakah kasir mengonfirmasi QR ini secara langsung?`,`Apakah ada kanal pembayaran resmi lain?`]},"job-offer":{mode:`message`,title:`Tawaran kerja berbiaya di muka`,subtitle:`Simulasi analisis teks rekrutmen`,summary:`Model menemukan kombinasi scarcity, otoritas palsu, dan permintaan deposit yang umum pada penipuan lowongan.`,confidenceLabel:`Scam pattern likelihood`,highlights:[{label:`Scarcity`,detail:`'posisi terbatas' mendorong keputusan cepat.`,x:14,y:19,w:48,h:18},{label:`Authority`,detail:`Mengatasnamakan perusahaan tanpa kanal resmi.`,x:26,y:43,w:54,h:18},{label:`Upfront fee`,detail:`Biaya administrasi diminta sebelum verifikasi HR.`,x:18,y:69,w:62,h:16}],clues:[`Ada biaya rekrutmen di muka`,`Klaim perusahaan belum diverifikasi`,`Tekanan waktu tinggi`,`Kontak HR resmi tersedia sebagai pembanding`],reflectiveQuestions:[`Apakah perusahaan resmi meminta deposit?`,`Apakah domain email pengirim cocok dengan perusahaan?`,`Bisakah posisi ini ditemukan di kanal karier resmi?`]},"bank-message":{mode:`link`,title:`Pesan bank dan tautan verifikasi`,subtitle:`Simulasi analisis teks + link`,summary:`Model menandai ancaman pemblokiran, otoritas bank, dan tautan verifikasi sebagai pola phishing berisiko tinggi.`,confidenceLabel:`Phishing likelihood`,highlights:[{label:`Threat`,detail:`Ancaman blokir 30 menit menciptakan rasa takut.`,x:12,y:18,w:55,h:18},{label:`External link`,detail:`Tautan mengarahkan keluar dari kanal resmi yang diketik sendiri.`,x:24,y:50,w:58,h:18},{label:`Credential risk`,detail:`Verifikasi identitas dapat berujung data pribadi/OTP.`,x:18,y:72,w:64,h:14}],clues:[`Menggunakan ancaman pemblokiran`,`Mengarahkan ke tautan`,`Mengatasnamakan institusi finansial`,`OTP dan kredensial tidak boleh dibagikan`],reflectiveQuestions:[`Apakah notifikasi yang sama ada di aplikasi bank resmi?`,`Apakah kamu mengetik alamat resmi sendiri, bukan dari link?`,`Apakah pesan meminta OTP atau data sensitif?`]},"viral-info":{mode:`message`,title:`Klaim viral tanpa sumber primer`,subtitle:`Simulasi analisis headline sosial`,summary:`Model menemukan ajakan menyebarkan segera, framing konspiratif, dan ketiadaan sumber primer.`,confidenceLabel:`Disinformation signal`,highlights:[{label:`Share pressure`,detail:`Ajakan menyebarkan muncul sebelum bukti diberikan.`,x:13,y:20,w:56,h:18},{label:`Conspiracy frame`,detail:`'mereka menutupi fakta' memancing curiga dan marah.`,x:22,y:45,w:58,h:18},{label:`No source`,detail:`Tidak ada sumber primer yang bisa diverifikasi.`,x:24,y:70,w:50,h:15}],clues:[`Viralitas dipakai sebagai tekanan sosial`,`Sumber primer tidak terlihat`,`Bahasa emosional kuat`,`Perlu cek tanggal dan konteks`],reflectiveQuestions:[`Sumber primer klaim ini apa?`,`Apakah ada laporan independen yang menyebut hal sama?`,`Apa dampaknya jika kamu share dan ternyata keliru?`]},"manipulated-media":{mode:`media`,title:`Video tokoh publik / media manipulatif`,subtitle:`Simulasi analisis visual + audio`,summary:`Model menandai area wajah, sinkronisasi audio, dan konteks unggahan sebagai sinyal yang perlu diverifikasi.`,confidenceLabel:`Synthetic media likelihood`,highlights:[{label:`Face sync`,detail:`Gerak mulut dan ekspresi tampak tidak sepenuhnya selaras.`,x:34,y:18,w:30,h:34},{label:`Hand / edge`,detail:`Tepi objek dan tangan tampak terlalu halus atau berubah bentuk.`,x:14,y:56,w:25,h:22},{label:`Call to invest`,detail:`Ajakan investasi segera muncul tanpa kanal resmi.`,x:47,y:67,w:38,h:16}],clues:[`Sinkronisasi wajah perlu diperiksa`,`Pola audio tampak tidak konsisten`,`Sumber unggahan tidak jelas`,`Ada ajakan finansial cepat`],reflectiveQuestions:[`Apakah video ini ada di kanal resmi tokoh?`,`Apakah ada versi asli dengan konteks lengkap?`,`Apakah produk investasi punya izin resmi?`]},"audio-impersonation":{mode:`audio`,title:`Rekaman suara impersonasi`,subtitle:`Simulasi pencocokan pola audio + transkrip`,summary:`Model simulasi menemukan tekanan transfer, perubahan prosodi, dan jejak kompresi. Kemiripan pola suara tidak membuktikan identitas pembicara.`,confidenceLabel:`Voice manipulation signal`,dataset:{name:`Voice Scam Pattern Set`,size:`18.420 sampel`,matches:`37 cluster serupa`},highlights:[{label:`Prosody shift`,detail:`Intonasi berubah tajam pada bagian permintaan transfer.`,start:`00:04`,end:`00:07`},{label:`Compression trace`,detail:`Ada pola kompresi berulang yang dapat berasal dari edit atau aplikasi pesan.`,start:`00:08`,end:`00:11`},{label:`Urgent instruction`,detail:`Frasa 'sekarang' dan 'jangan telepon' membatasi verifikasi.`,start:`00:12`,end:`00:16`}],clues:[`Kemiripan suara bukan bukti identitas`,`Ada larangan melakukan verifikasi`,`Aksi finansial diminta segera`,`Konteks rekaman tidak lengkap`],reflectiveQuestions:[`Sudahkah kamu menelepon nomor keluarga yang tersimpan?`,`Adakah pertanyaan yang hanya keluarga asli dapat jawab?`,`Apa risiko jika model salah membaca audio terkompresi?`]},"ai-can-be-wrong":{mode:`official`,title:`Kemungkinan false positive AI`,subtitle:`Simulasi analisis dengan bukti resmi lebih kuat`,summary:`Model menemukan format massal yang tampak mencurigakan, tetapi bukti pada aplikasi resmi dapat membantah sinyal AI.`,confidenceLabel:`Suspicious signal`,highlights:[{label:`Formal template`,detail:`Format pengumuman massal kadang mirip pesan palsu.`,x:14,y:22,w:54,h:18},{label:`Official channel needed`,detail:`Keputusan harus mengikuti bukti di aplikasi/kanal resmi.`,x:20,y:54,w:60,h:18}],clues:[`Sinyal AI tidak sama dengan kebenaran`,`Bukti resmi bisa lebih kuat`,`Format formal dapat memicu false positive`,`Manusia tetap memegang keputusan akhir`],reflectiveQuestions:[`Apakah aplikasi resmi menampilkan pengumuman yang sama?`,`Bukti mana yang lebih dapat diverifikasi daripada skor AI?`,`Kapan kamu perlu tidak setuju dengan AI?`]}};function a(){return r[d.scenarioId]||r[`family-emergency`]}function o(){return i[d.scenarioId]||i[`family-emergency`]}function s(){return d.trainingScenario?a():d.inputType===`image`?r[`manipulated-media`]:d.inputType===`audio`?r[`audio-impersonation`]:d.inputType===`qr`?r[d.qrInputMode===`image`?`qr-payment`:`bank-message`]:a()}function c(){return d.trainingScenario?o():d.inputType===`image`?i[`manipulated-media`]:d.inputType===`audio`?i[`audio-impersonation`]:d.inputType===`qr`?i[d.qrInputMode===`image`?`qr-payment`:`bank-message`]:o()}function l(e){try{return new URL(e).hostname}catch{return`domain-belum-terbaca`}}function u(){return n.find(e=>e.id===d.scenarioId)||n[0]}var d={route:`verify`,inputType:`text`,content:e,fileName:``,imageDataUrl:``,audioDataUrl:``,qrImageDataUrl:``,qrInputMode:`link`,xaiMode:`bounding`,audioXaiMode:`voice`,qrXaiMode:`risk`,inFlow:!1,directDetection:!1,stage:2,hadangStep:0,initialDecision:``,initialConfidence:68,pressure:[],emotion:[],neutralImpact:``,evidence:``,requestedAction:``,consequence:``,saferAction:``,finalDecision:``,finalConfidence:72,reflection:[],priority:``,result:!1,questionOpen:!0,gameScore:0,gameLives:3,gameCombo:1,gameCatches:0,gameRoundComplete:!1,gameOver:!1,guardY:54,scenarioId:`family-emergency`,aiWrong:!1,trainingScenario:!1,casePrompt:``},f=document.querySelector(`#app`),p=document.querySelector(`#toast`),m;function h(e,t=!0){let n=e===`light`?`light`:`blue`;document.documentElement.dataset.theme=n;let r=document.querySelector(`[data-theme-toggle]`),i=n===`light`;if(r){let e=i?`Gunakan tema biru gelap`:`Gunakan tema putih biru`;r.setAttribute(`aria-label`,e),r.setAttribute(`aria-pressed`,String(i)),r.title=e}if(t)try{localStorage.setItem(`hadangin-theme`,n)}catch{}}h(document.documentElement.dataset.theme,!1);function g(e=``){return String(e).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#039;`)}function _(e){clearTimeout(m),p.textContent=e,p.classList.add(`show`),m=setTimeout(()=>p.classList.remove(`show`),2800)}function v(){let e=location.hash.replace(/^#\/?/,``).split(`/`)[0];return e===`training`?`training`:e===`community`?`community`:e===`dashboard`?`dashboard`:e===`how-it-works`?`how`:e===`about`?`about`:`verify`}function y(){document.querySelectorAll(`[data-route]`).forEach(e=>{e.classList.toggle(`active`,e.dataset.route===d.route)}),document.querySelector(`.main-nav`).classList.remove(`open`),document.querySelector(`.menu-toggle`).setAttribute(`aria-expanded`,`false`)}function b(){Object.assign(d,{inFlow:!1,directDetection:!1,stage:2,hadangStep:0,initialDecision:``,initialConfidence:68,pressure:[],emotion:[],neutralImpact:``,evidence:``,requestedAction:``,consequence:``,saferAction:``,finalDecision:``,finalConfidence:72,reflection:[],priority:``,result:!1,questionOpen:!0,gameScore:0,gameLives:3,gameCombo:1,gameCatches:0,gameRoundComplete:!1,gameOver:!1,guardY:54,aiWrong:!1})}function x(e={}){oe(),window.dispatchEvent(new CustomEvent(`hadang:before-render`));let t=window.scrollY,n=document.querySelector(`.game-question-panel`)?.scrollTop||0;d.route=v(),y(),f.innerHTML=d.route===`training`?Fe():d.route===`community`?Ee():d.route===`dashboard`?Pe():d.route===`how`?Ie():d.route===`about`?Le():d.inFlow?k():w(),window.dispatchEvent(new CustomEvent(`hadang:rendered`,{detail:{route:d.route}})),requestAnimationFrame(I),document.body.classList.toggle(`game-active`,d.route===`verify`&&d.inFlow&&d.stage===3),requestAnimationFrame(()=>{if(e.preserveScroll){window.scrollTo({top:t,behavior:`instant`});let e=document.querySelector(`.game-question-panel`);e&&(e.scrollTop=n)}else window.scrollTo({top:0,behavior:`instant`})})}function S(){return`
    ...
    </section>`}function C(){return`<section class="section section-white onboarding-section" id="onboarding">
    ...
    </div>`}function T(e,t){return`<button class="tab ${d.inputType===e?`active`:``}" role="tab" aria-selected="${d.inputType===e}" data-input-type="${e}">${t}</button>`}function E(){if(d.inputType===`text`)return`<div class="input-zone"><textarea id="content-input" aria-label="Teks atau pesan mencurigakan" placeholder="Tempel pesan atau klaim di sini...">${g(d.content)}</textarea></div>`;if(d.inputType===`qr`){let e=`<div class="media-input-modes" role="group" aria-label="Cara memasukkan QR atau tautan"><button type="button" class="${d.qrInputMode===`link`?`active`:``}" data-qr-input-mode="link">Tempel Tautan</button><button type="button" class="${d.qrInputMode===`image`?`active`:``}" data-qr-input-mode="image">Upload QR</button></div>`;return d.qrInputMode===`image`?d.qrImageDataUrl?`${e}<div class="image-upload-preview qr-upload-preview" data-drop-zone><div class="uploaded-image-frame"><img src="${d.qrImageDataUrl}" alt="Preview QR ${g(d.fileName)}" /></div><div class="uploaded-file-meta"><div><span>QR siap diperiksa</span><strong>${g(d.fileName)}</strong><small>AI simulasi akan memetakan struktur QR dan tujuan yang terbaca.</small></div><div class="button-row"><label class="button button-secondary button-small" for="file-input">Ganti QR</label><button class="icon-remove" type="button" data-action="remove-qr" aria-label="Hapus QR" title="Hapus QR">&times;</button></div></div><input class="file-input" id="file-input" type="file" accept="image/*" /></div>`:`${e}<div class="input-zone" data-drop-zone><div class="upload-content"><div class="upload-symbol" aria-hidden="true">#</div><strong>Upload gambar QR</strong><p>Tarik screenshot atau foto QR ke sini. PNG, JPG, dan WEBP hingga 10 MB.</p><label class="button button-secondary" for="file-input">Pilih Gambar QR</label><input class="file-input" id="file-input" type="file" accept="image/*" /></div></div>`:`${e}<div class="link-input-zone"><div class="link-input-icon" aria-hidden="true">//</div><div><strong>Alamat tujuan yang ingin diperiksa</strong><p>Tautan tidak akan dibuka. Simulasi hanya membaca struktur alamatnya.</p></div><input id="content-input" type="url" aria-label="Tautan mencurigakan" placeholder="https://contoh-tautan.com/verifikasi" value="${d.content.startsWith(`http`)?g(d.content):``}" /><div class="link-safety-note"><span></span>Pratinjau aman: tanpa membuka situs tujuan</div></div>`}let e=d.inputType===`audio`;return e&&d.audioDataUrl?`<div class="audio-upload-preview" data-drop-zone><div class="audio-file-head"><div class="audio-file-icon" aria-hidden="true">~</div><div><span>Rekaman siap diperiksa</span><strong>${g(d.fileName)}</strong><small>Putar dan dengarkan konteks sebelum memulai.</small></div><button class="icon-remove" type="button" data-action="remove-audio" aria-label="Hapus audio" title="Hapus audio">&times;</button></div>${D(42,`input-wave`)}<audio controls preload="metadata" src="${d.audioDataUrl}">Browser tidak mendukung pemutar audio.</audio><label class="button button-secondary button-small" for="file-input">Ganti Audio</label><input class="file-input" id="file-input" type="file" accept="audio/*" /></div>`:!e&&d.imageDataUrl?`<div class="image-upload-preview" data-drop-zone>
      <div class="uploaded-image-frame"><img src="${d.imageDataUrl}" alt="Preview ${g(d.fileName)}" /></div>
      <div class="uploaded-file-meta"><div><span>Gambar siap diperiksa</span><strong>${g(d.fileName)}</strong><small>Gambar akan tetap terlihat sampai tahap Explainable AI.</small></div><div class="button-row"><label class="button button-secondary button-small" for="file-input">Ganti Gambar</label><button class="icon-remove" type="button" data-action="remove-image" aria-label="Hapus gambar" title="Hapus gambar">&times;</button></div></div>
      <input class="file-input" id="file-input" type="file" accept="image/*" />
    </div>`:`<div class="input-zone" data-drop-zone><div class="upload-content"><div class="upload-symbol" aria-hidden="true">${e?`~`:`+`}</div><strong>${d.fileName?g(d.fileName):`Pilih ${e?`rekaman audio`:`gambar atau screenshot`}`}</strong><p>${e?`Tarik MP3, WAV, atau M4A hingga 10 MB`:`Tarik gambar ke sini atau pilih PNG, JPG, dan WEBP hingga 10 MB`}</p><label class="button button-secondary" for="file-input">Pilih File</label><input class="file-input" id="file-input" type="file" accept="${e?`audio/*`:`image/*`}" /></div></div>`}function D(e=48,t=``){return`<div class="audio-waveform ${t}" aria-hidden="true">${Array.from({length:e},(e,t)=>`<i style="--amp:${22+(t*37+t*t*3)%70}%"></i>`).join(``)}</div>`}function O(){let e=[`Content`,`My Judgment`,`J.E.D.A.`,`AI Lens`,`Final Decision`,`Reflection`],t=d.result?6:d.stage;return`<div class="progress-wrap">
  ...
  </div>`}function k(){if(d.directDetection)return L();let e=A();d.stage===3&&(e=N()),d.stage===4&&(e=xe()),d.stage===5&&(e=Se()),d.stage===6&&(e=d.result?R():Ce());let t=d.stage===3;return`${O()}<section class="flow-canvas ${t?`game-flow-canvas`:``}"><div class="${t?`game-flow-shell`:`page-shell`}">${e}</div></section>`}function A(){let e=[`Lanjut`,`Verifikasi Dulu`,`Berhenti`,`Belum Yakin`],t=u();return`<div class="flow-card">
    <header><p class="section-kicker">Human First</p><h2>Sebelum AI Membantu...</h2><p>Kami ingin tahu bagaimana kamu membaca situasi ini terlebih dahulu.</p>${d.trainingScenario?`<div class="active-case-ribbon"><span>Kasus ${t.no}</span><strong>${g(t.title)}</strong><i>${g(t.format)}</i></div>`:``}</header>
    ${ee()}
    <div class="question">
      <span class="question-label">Apa respons pertamamu jika ini terjadi di dunia nyata?</span>
      <div class="choice-grid">${e.map(e=>M(e,d.initialDecision,`initial-decision`)).join(``)}</div>
    </div>
    <div class="question">
      <span class="question-label">Seberapa yakin kamu dengan keputusan itu?</span>
      ${j(`initial-confidence`,d.initialConfidence)}
      <p class="helper">AI belum akan ditampilkan sampai kamu menyelesaikan tahap berpikir awal.</p>
    </div>
    <div class="flow-actions"><button class="button button-ghost" data-action="cancel-flow">Kembali</button><button class="button" data-action="lock-initial" ${d.initialDecision?``:`disabled`}>Kunci Penilaian Awal</button></div>
  </div>`}function ee(){return d.trainingScenario?te(u()):d.inputType===`image`&&d.imageDataUrl?`<div class="human-image-context"><img src="${d.imageDataUrl}" alt="Gambar yang sedang diperiksa" /><div><span class="label">Gambar yang diperiksa</span><strong>${g(d.fileName)}</strong><p>Amati konteks, sumber, detail visual, dan tindakan yang diminta sebelum melihat analisis AI.</p></div></div>`:d.inputType===`audio`&&d.audioDataUrl?`<div class="human-audio-context"><div><span class="label">Rekaman yang diperiksa</span><strong>${g(d.fileName)}</strong>${D(38,`human-wave`)}<audio controls preload="metadata" src="${d.audioDataUrl}"></audio></div><div class="transcript-preview"><span>Transkrip simulasi</span><p>"Nak, ini Mama. Nomor Mama sedang bermasalah. Tolong transfer sekarang dan jangan telepon dulu."</p><small>Transkrip ini adalah contoh frontend, bukan hasil speech-to-text aktual.</small></div></div>`:d.inputType===`qr`&&d.qrInputMode===`image`&&d.qrImageDataUrl?`<div class="human-image-context"><img src="${d.qrImageDataUrl}" alt="QR yang sedang diperiksa" /><div><span class="label">QR yang diperiksa</span><strong>${g(d.fileName)}</strong><p>Periksa lokasi QR, pemilik media, serta nama penerima sebelum memindai atau membayar.</p></div></div>`:d.inputType===`qr`?`<div class="human-link-context"><span class="label">Tautan yang diperiksa</span><strong>${g(l(d.content))}</strong><code>${g(d.content)}</code><p>Jangan buka tautan dari panel ini. Nilai klaim pengirim dan cari kanal resmi secara mandiri.</p></div>`:`<div class="message-panel"><span class="label">Informasi yang diperiksa</span><blockquote>${g(d.content||e)}</blockquote></div>`}function te(e){return e.inputType===`qr`&&e.inputMode===`image`?`<div class="training-case-context"><div class="case-visual qr-case"><div class="qr-pattern" aria-label="Ilustrasi QR pembayaran"><span></span><span></span><span></span></div><i>STIKER BARU</i><small>MEJA KASIR</small></div><div class="case-copy"><span class="label">${g(e.source)}</span><strong>QR pembayaran pengganti</strong><blockquote>${g(e.content)}</blockquote><p>Amati posisi stiker dan pastikan nama penerima sebelum memindai.</p></div></div>`:e.inputType===`qr`?`<div class="human-link-context"><span class="label">${g(e.source)}</span><blockquote>${g(e.content)}</blockquote><strong>${g(l(d.content))}</strong><code>${g(d.content)}</code><p>Alamat ditampilkan tanpa dibuka. Cocokkan dengan domain resmi melalui kanal independen.</p></div>`:e.inputType===`audio`?`<div class="human-audio-context training-audio-context"><div><span class="label">${g(e.source)}</span><strong>Voice note keluarga / 00:18</strong>${D(38,`human-wave`)}<div class="audio-simulation-status"><i></i>Rekaman latihan siap dianalisis</div></div><div class="transcript-preview"><span>Transkrip kasus</span><p>"${g(e.content)}"</p><small>Perhatikan larangan menelepon dan permintaan transfer mendesak.</small></div></div>`:e.inputType===`image`?`<div class="training-case-context"><div class="case-visual ${e.id===`manipulated-media`?`video-case`:`social-case`}">${e.id===`manipulated-media`?`<div class="video-person"><span></span></div><b>LIVE</b><em>INVESTASI HANYA HARI INI</em>`:`<div class="social-avatar"></div><small>${e.id===`job-offer`?`INFO KARIER`:`UNGGAHAN VIRAL`}</small><strong>${g(e.content)}</strong><div class="social-stats"><span>12,8K</span><span>Bagikan</span></div>`}</div><div class="case-copy"><span class="label">${g(e.source)}</span><strong>${g(e.title)}</strong><blockquote>${g(e.content)}</blockquote><p>${g(e.mission)}</p></div></div>`:`<div class="message-panel training-message-context"><div class="message-meta"><span>${g(e.source)}</span><i>${g(e.format)}</i></div><span class="label">Informasi yang diperiksa</span><blockquote>${g(e.content)}</blockquote><p>${g(e.mission)}</p></div>`}function j(e,t){return`<div class="confidence-box"><div class="confidence-head"><span>0 - belum yakin</span><span class="confidence-value">${t}% yakin</span></div><input type="range" min="0" max="100" value="${t}" data-range="${e}" aria-label="Tingkat keyakinan ${t} persen" /></div>`}function M(e,t,n,r=``){return`<button class="choice ${t===e?`selected ${r}`:``}" data-select="${n}" data-value="${g(e)}">${g(e)}</button>`}function ne(e,t,n){return`<button class="choice ${t.includes(e)?`selected selected-teal`:``}" data-multi="${n}" data-value="${g(e)}">${g(e)}</button>`}function N(){if(d.hadangStep===-1)return re();let e=[`Jeda`,`Emosi`,`Data`,`Aksi`],t=[d.pressure.length>0,d.emotion.length>0,!!d.evidence,!!d.requestedAction][d.hadangStep];return`<div class="hadang-play-layout fullscreen-play-layout">
    <div class="game-world fullscreen-game-world">
      ${ie()}
      <div class="live-readout"><span class="live-dot"></span><div><small>STATUS ARENA</small><strong data-game-status>${d.gameRoundComplete?`Token tertangkap. Buka pertanyaan ${e[d.hadangStep]}.`:`Gerakkan penjaga ${e[d.hadangStep]} dan tangkap token.`}</strong></div><div class="game-live-stats"><span><small>SKOR</small><b data-game-score>${d.gameScore}</b></span><span><small>NYAWA</small><b data-game-lives>${`&#9829;`.repeat(d.gameLives)}${`&#9825;`.repeat(3-d.gameLives)}</b></span></div></div>
      ${d.questionOpen?`<div class="question-scrim" aria-hidden="true"></div>`:``}
      ${d.questionOpen?`<aside class="game-question-panel game-question-modal ${t?`settled`:`entering`}" id="game-question-panel" role="dialog" aria-modal="false" aria-label="Pertanyaan penjaga ${e[d.hadangStep]}">
        <div class="question-panel-top"><span>POS PENJAGA 0${d.hadangStep+1}</span><span>${d.hadangStep+1} / 4</span><button class="question-close" type="button" data-action="hide-question" aria-label="Tutup pertanyaan" title="Tutup pertanyaan">&times;</button></div>
        ${pe()}
      </aside>`:`<button class="question-reopen" type="button" data-action="focus-question"><span>0${d.hadangStep+1}</span><strong>Buka Pertanyaan ${e[d.hadangStep]}</strong></button>`}
    </div>
  </div>`}function re(){return`<div class="transition-panel game-transition game-fullscreen-intro">
    ${ae(-1,!0)}
  ...
  </div>`}function ie(){return ae(d.hadangStep,!1)}function ae(e,t=!1){let n=[[`J`,`JEDA`,22],[`E`,`EMOSI`,40],[`D`,`DATA`,58],[`A`,`AKSI`,76]],r=e<0?0:e,i=t?8:[12,31,49,67][r];return`<div class="hadang-game-stage ${t?`intro-stage`:`arena-stage interactive-arena`}" style="--token-left:${i}%; --player-y:${d.guardY}%" tabindex="${t?`-1`:`0`}" aria-label="Arena Gobak Sodor Hadang Nalar, garis aktif ${n[r][1]}">
    ...
    ${!t&&d.gameOver?`<div class="game-over-panel"><span>MISI GAGAL</span><strong>Tiga informasi lolos.</strong><p>Ulangi ronde dan jaga garis ${n[r][1]}.</p><button class="button button-teal" type="button" data-action="retry-round">Ulangi Ronde</button></div>`:``}
  </div>`}var P=null,F=new Set;function oe(){P&&(cancelAnimationFrame(P.frame),P=null,F.clear())}function I(){let e=document.querySelector(`.arena-stage.interactive-arena`);!e||d.questionOpen||d.gameRoundComplete||d.gameOver||se(e)}function se(e){oe();let t=[22,40,58,76][d.hadangStep],n=[`pesan mendesak`,`tautan palsu`,`QR mencurigakan`,`voice note`,`klaim viral`],r=d.gameCatches+(3-d.gameLives)+d.hadangStep,i=[36,66,43,62,32,57][r%6],a={stage:e,token:e.querySelector(`[data-game-token]`),guard:e.querySelector(`.player-guard`),x:Math.max(6,t-17),y:i,guardY:Math.min(70,Math.max(31,d.guardY)),guardLeft:t,speed:7.3+d.hadangStep*.65,blockingUntil:0,lastTime:performance.now(),frame:0};P=a,a.token?.classList.remove(`caught`,`escaped`),a.guard?.classList.remove(`caught-token`,`is-blocking`);let o=n[r%n.length];a.token?.querySelector(`[data-token-kind]`)?.replaceChildren(o),e.classList.add(`game-running`),e.focus({preventScroll:!0});let s=e=>{if(P!==a||!a.token||!a.guard)return;let t=Math.min((e-a.lastTime)/1e3,.05);a.lastTime=e;let n=(F.has(`arrowdown`)||F.has(`s`)?1:0)-(F.has(`arrowup`)||F.has(`w`)?1:0);a.guardY=Math.min(70,Math.max(31,a.guardY+n*38*t)),a.x+=a.speed*t,a.guard.style.top=`${a.guardY}%`,a.token.style.left=`${a.x}%`,a.token.style.top=`${a.y}%`,a.guard.classList.toggle(`is-blocking`,e<a.blockingUntil);let r=e<a.blockingUntil?14:8,i=Math.abs(a.x-a.guardLeft)<1.25,o=Math.abs(a.y-a.guardY)<r;if(i&&o){le(a);return}if(a.x>a.guardLeft+8){ue(a);return}a.frame=requestAnimationFrame(s)};a.frame=requestAnimationFrame(s)}function ce(){P&&(P.blockingUntil=performance.now()+650,P.guard?.classList.add(`is-blocking`))}function le(e){P===e&&(cancelAnimationFrame(e.frame),e.token.classList.add(`caught`),e.guard.classList.add(`caught-token`),d.guardY=e.guardY,d.gameCatches+=1,d.gameScore+=100*d.gameCombo,d.gameCombo=Math.min(4,d.gameCombo+1),d.gameRoundComplete=!0,de(`Token tertangkap di garis ${[`Jeda`,`Emosi`,`Data`,`Aksi`][d.hadangStep]}!`,!0),P=null,setTimeout(()=>{d.questionOpen=!0,x({preserveScroll:!0})},520))}function ue(e){P===e&&(cancelAnimationFrame(e.frame),e.token.classList.add(`escaped`),d.guardY=e.guardY,d.gameLives=Math.max(0,d.gameLives-1),d.gameCombo=1,de(`Informasi lolos. Bersiap untuk token berikutnya.`,!1),P=null,d.gameLives===0?(d.gameOver=!0,setTimeout(()=>x({preserveScroll:!0}),480)):setTimeout(()=>I(),620))}function de(e,t){let n=document.querySelector(`[data-game-status]`),r=document.querySelector(`[data-game-score]`),i=document.querySelector(`[data-game-lives]`);n&&(n.textContent=e),r&&(r.textContent=d.gameScore),i&&(i.innerHTML=`${`&#9829;`.repeat(d.gameLives)}${`&#9825;`.repeat(3-d.gameLives)}`),document.querySelector(`.live-readout`)?.classList.toggle(`catch-success`,t)}function fe(e=!1){oe(),e&&(d.gameLives=3,d.gameCombo=1),d.gameRoundComplete=!1,d.gameOver=!1,d.questionOpen=!1,d.guardY=54}function pe(){let e=a();if(d.hadangStep===0)return`<header><p class="section-kicker">Garis 01 - Jeda</p><h2>Berhenti sejenak dari dorongan bertindak.</h2><p>Apa yang membuat informasi ini terasa harus segera ditindaklanjuti?</p></header>
      <div class="choice-grid compact">${[`Deadline`,`Darurat`,`Ancaman`,`Hadiah`,`Kesempatan terbatas`,`Tekanan sosial`,`Tidak ada tekanan`].map(e=>ne(e,d.pressure,`pressure`)).join(``)}</div>
      ${d.pressure.length?`<div class="insight"><div><strong>Ruang berpikir sedang dipersempit.</strong><br>Tekanan waktu dapat mengurangi ruang untuk mengevaluasi informasi.</div></div>`:``}
      ${me(`Hadang Garis 1`,d.pressure.length>0)}`;if(d.hadangStep===1)return`<header><p class="section-kicker">Garis 02 - Emosi</p><h2>Kenali emosi yang sedang dipancing.</h2><p>Emosi bukan kesalahan. Mengenalinya membantu kamu menjaga jarak dari tekanan.</p></header>
      <div class="choice-grid compact">${[`Takut`,`Panik`,`Kasihan`,`Percaya`,`Marah`,`FOMO`,`Harapan`,`Penasaran`,`Kedekatan emosional`,`Tidak yakin`].map(e=>ne(e,d.emotion,`emotion`)).join(``)}</div>
      <div class="neutralizer">
        <div class="message-panel"><span class="label">Pesan asli - tekanan aktif</span><blockquote>${g(e.neutralOriginal)}</blockquote></div>
        <div class="message-panel neutral"><span class="label">Tanpa tekanan emosi</span><blockquote>${g(e.neutralVersion)}</blockquote></div>
      </div>
      <div class="question"><span class="question-label">Setelah bahasanya dibuat netral, apakah keputusanmu terasa berbeda?</span><div class="choice-grid compact">${[`Ya`,`Sedikit`,`Tidak`].map(e=>M(e,d.neutralImpact,`neutral-impact`)).join(``)}</div></div>
      ${me(`Hadang Garis 2`,d.emotion.length>0&&d.neutralImpact)}`;if(d.hadangStep===2){let t=e.evidenceOptions;return`<header><p class="section-kicker">Garis 03 - Data</p><h2>Pisahkan klaim dari buktinya.</h2><p>Bukti yang baik tidak hanya berasal dari pihak yang membuat klaim.</p></header>
      <div class="split-evidence"><section><h4>Klaim</h4><p>${g(e.claim)}</p></section><section><h4>Bukti independen</h4><p>${d.evidence?g(d.evidence):`Belum dipilih`}</p></section></div>
      <div class="question"><span class="question-label">Mana yang paling independen untuk memverifikasi klaim ini?</span><div class="choice-grid">${t.map(e=>M(e,d.evidence,`evidence`)).join(``)}</div></div>
      ${d.evidence?`<div class="insight"><div><strong>${d.evidence===e.preferredEvidence?`Pilihan verifikasi yang kuat.`:`Bukti ini belum cukup independen.`}</strong><br>Bandingkan informasi melalui kanal yang tidak diberikan oleh pesan mencurigakan.</div></div>`:``}
      ${me(`Hadang Garis 3`,!!d.evidence)}`}let t=e.actionOptions,n=e.riskOptions,r=e.saferOptions;return`<header><p class="section-kicker">Garis 04 - Aksi</p><h2>Lihat tindakan dan konsekuensinya.</h2><p>Pesan manipulatif sering dibuat untuk mempercepat aksi yang sulit dibatalkan.</p></header>
    <div class="question"><span class="question-label">Apa sebenarnya yang diminta informasi ini darimu?</span><div class="choice-grid compact">${t.map(e=>M(e,d.requestedAction,`requested-action`)).join(``)}</div></div>
    <div class="question"><span class="question-label">Apa konsekuensinya jika keputusanmu salah?</span><div class="choice-grid">${n.map(e=>M(e,d.consequence,`consequence`)).join(``)}</div></div>
    <div class="question"><span class="question-label">Apa langkah alternatif yang lebih aman?</span><div class="choice-grid">${r.map(e=>M(e,d.saferAction,`safer-action`)).join(``)}</div></div>
    ${me(`Hadang Sebelum Bertindak`,d.requestedAction&&d.consequence&&d.saferAction)}`}function me(e,t){return`<div class="flow-actions"><button class="button button-ghost" data-action="hadang-back">Kembali</button><button class="button button-teal" data-action="hadang-next" ${t?``:`disabled`}>${e}</button></div>`}function he(t,n){let r=d.content||e,i=d.inputType===`image`&&d.imageDataUrl,a=d.inputType===`audio`&&d.audioDataUrl,o=d.inputType===`image`&&(i||d.trainingScenario),s=d.inputType===`audio`&&(a||d.trainingScenario),c=d.inputType===`qr`,l=n.dataset||(c?{name:d.qrInputMode===`image`?`QR Abuse Reference Set`:`URL Threat Pattern Set`,size:d.qrInputMode===`image`?`42.680 struktur QR`:`1,2 juta snapshot URL`,matches:d.qrInputMode===`image`?`19 pola tujuan serupa`:`63 pola domain serupa`}:null),f=`${be(n,r)}${n.highlights.map((e,t)=>`<span class="red-box" style="--x:${e.x}%; --y:${e.y}%; --w:${e.w}%; --h:${e.h}%"><b>${t+1}</b></span>`).join(``)}`;return o&&(f=`<div class="xai-image-stage">${i?`<img class="xai-source-image" src="${d.imageDataUrl}" alt="Gambar upload dengan penjelasan XAI" />`:ge(u())}${d.xaiMode===`heatmap`?`<div class="xai-heatmap" aria-hidden="true">${n.highlights.map(e=>`<span style="--hx:${e.x+e.w/2}%; --hy:${e.y+e.h/2}%; --hs:${Math.max(e.w,e.h)*1.7}%"></span>`).join(``)}</div>`:n.highlights.map((e,t)=>`<span class="red-box" style="--x:${e.x}%; --y:${e.y}%; --w:${e.w}%; --h:${e.h}%"><b>${t+1}</b></span>`).join(``)}</div>`),s&&(f=ve()),c&&(f=ye()),`<section class="detection-panel" aria-label="Explainable AI detection simulation">
    <div class="detection-header">
      <div><p class="section-kicker">Explainable detection</p><h3>${g(n.title)}</h3><p>${g(n.subtitle)}</p></div>
      <div class="confidence-badge"><span>${g(n.confidenceLabel)}</span><strong>${t.aiScore}%</strong></div>
    </div>
    ${_e(o,s,c)}
    <div class="detection-grid">
      <div class="detection-preview ${g(n.mode)}">
        <div class="preview-toolbar"><span></span><span></span><span></span><strong>AI Context Scan</strong></div>
        <div class="preview-canvas ${o?`uploaded-xai ${d.xaiMode}`:``} ${s?`audio-xai ${d.audioXaiMode}`:``} ${c?`qr-xai ${d.qrXaiMode}`:``}">
          ${f}
          ${o?`<div class="xai-legend"><span><i></i>${d.xaiMode===`heatmap`?`Pengaruh tinggi`:`Area perhatian model`}</span><small>Simulasi XAI</small></div>`:``}
        </div>
      ...
      <div class="detection-explain">
        <p class="detection-summary">${g(n.summary)}</p>
        ${l?`<div class="dataset-card"><span>Dataset referensi simulasi</span><strong>${g(l.name)}</strong><div><small>${g(l.size)}</small><small>${g(l.matches)}</small></div><p>Statistik dibuat untuk demonstrasi UI dan bukan hasil model produksi.</p></div>`:``}
        <div class="highlight-list">
          ${n.highlights.map((e,t)=>`<article><span>${t+1}</span><div><h4>${g(e.label)}${e.start?`<small>${g(e.start)}-${g(e.end)}</small>`:``}</h4><p>${g(e.detail)}</p></div></article>`).join(``)}
        </div>
      </div>
    </div>
    <div class="clue-question-grid">
      <section class="info-panel clue-panel"><h3>Clue yang terlihat</h3><ul>${n.clues.map(e=>`<li>${g(e)}</li>`).join(``)}</ul></section>
      <section class="info-panel question-panel"><h3>Pertanyaan reflektif</h3><ul>${n.reflectiveQuestions.map(e=>`<li>${g(e)}</li>`).join(``)}</ul></section>
    </div>
  </section>`}function ge(e){return e.id===`manipulated-media`?`<div class="training-xai-source video-xai-source"><span class="xai-subject"></span><b>LIVE</b><div><small>AKUN TIDAK TERVERIFIKASI</small><strong>Investasi eksklusif hanya hari ini</strong></div></div>`:`<div class="training-xai-source social-xai-source"><div class="xai-post-head"><span></span><div><small>${e.id===`job-offer`?`INFO KARIER`:`AKUN VIRAL`}</small><b>${e.id===`job-offer`?`Rekrutmen prioritas`:`12,8 ribu kali dibagikan`}</b></div></div><strong>${g(e.content)}</strong><div class="xai-post-action">${e.id===`job-offer`?`Bayar biaya administrasi`:`Sebarkan sekarang`}</div></div>`}function _e(e,t,n){return e?`<div class="xai-mode-bar"><div><strong>Visual Penjelasan XAI</strong><span>Pilih cara model menampilkan area yang memengaruhi sinyal.</span></div><div class="xai-segmented" role="group" aria-label="Mode visual XAI"><button class="${d.xaiMode===`bounding`?`active`:``}" type="button" data-xai-mode="bounding">Bounding Box</button><button class="${d.xaiMode===`heatmap`?`active`:``}" type="button" data-xai-mode="heatmap">Heatmap</button></div></div>`:t?`<div class="xai-mode-bar"><div><strong>Penjelasan Pola Audio</strong><span>Bandingkan sinyal suara dan distribusi frekuensi simulatif.</span></div><div class="xai-segmented" role="group" aria-label="Mode analisis audio"><button class="${d.audioXaiMode===`voice`?`active`:``}" type="button" data-audio-xai-mode="voice">Voice Pattern</button><button class="${d.audioXaiMode===`spectrogram`?`active`:``}" type="button" data-audio-xai-mode="spectrogram">Spectrogram</button></div></div>`:n?`<div class="xai-mode-bar"><div><strong>Penjelasan Risiko Tujuan</strong><span>Lihat sinyal struktur dan jalur yang mungkin dilalui.</span></div><div class="xai-segmented" role="group" aria-label="Mode analisis QR atau tautan"><button class="${d.qrXaiMode===`risk`?`active`:``}" type="button" data-qr-xai-mode="risk">Risk Map</button><button class="${d.qrXaiMode===`redirect`?`active`:``}" type="button" data-qr-xai-mode="redirect">Redirect Chain</button></div></div>`:``}function ve(){return`<div class="audio-analysis-stage"><div class="audio-analysis-meta"><span>VOICE SAMPLE / 00:18</span><b>${d.audioXaiMode===`voice`?`Pola suara`:`Spektrum frekuensi`}</b></div><div class="${d.audioXaiMode===`spectrogram`?`spectrogram-panel`:`voice-pattern-panel`}">${D(58,`analysis-wave`)}<span class="audio-marker marker-one">1</span><span class="audio-marker marker-two">2</span><span class="audio-marker marker-three">3</span></div><div class="audio-time-axis"><span>00:00</span><span>00:06</span><span>00:12</span><span>00:18</span></div>${d.audioDataUrl?`<audio controls preload="metadata" src="${d.audioDataUrl}"></audio>`:`<div class="audio-simulation-status"><i></i>Sampel audio skenario aktif</div>`}<div class="ai-transcript"><span>Transkrip simulasi</span><p>Nak, ini Mama. Nomor Mama bermasalah. <mark>Tolong transfer sekarang</mark> dan <mark>jangan telepon dulu</mark>.</p></div></div>`}function ye(){let e=d.qrInputMode===`image`&&(d.qrImageDataUrl||d.trainingScenario);if(d.qrXaiMode===`redirect`)return`<div class="redirect-analysis"><span class="analysis-label">SIMULATED REDIRECT TRACE</span><div class="redirect-chain"><div><i>1</i><span>Input pengguna<small>${e?`QR image decode`:g(l(d.content))}</small></span></div><b></b><div class="warn"><i>2</i><span>Short redirect<small>tracking-gateway.example</small></span></div><b></b><div class="danger"><i>3</i><span>Form kredensial<small>secure-login-check.example</small></span></div></div><p>Rantai ini adalah visualisasi dataset simulasi. HADANGIN tidak membuka alamat tersebut.</p></div>`;if(e)return`<div class="qr-image-analysis">${d.qrImageDataUrl?`<img src="${d.qrImageDataUrl}" alt="QR upload dalam pemetaan risiko" />`:`<div class="qr-case-scan"><div class="qr-pattern" aria-label="QR skenario latihan"><span></span><span></span><span></span></div><small>STIKER TERDETEKSI</small></div>`}<span class="qr-scan-line"></span><span class="qr-focus focus-a">1</span><span class="qr-focus focus-b">2</span></div><div class="qr-destination"><span>Tujuan terbaca / simulasi</span><strong>merchant-pay-check.example</strong><small>Nama penerima belum cocok dengan merchant</small></div>`;let t=l(d.content);return`<div class="url-risk-analysis"><span class="analysis-label">URL TOKEN RISK MAP</span><div class="url-token-map">${d.content.replace(/^https?:\/\//i,``).split(/([./?=&-])/).filter(Boolean).slice(0,18).map((e,t)=>`<span class="${t===0||/login|verify|secure|otp/i.test(e)?`flagged`:``}">${g(e)}</span>`).join(``)}</div><div class="domain-facts"><div><span>Host terbaca</span><strong>${g(t)}</strong></div><div><span>Pola terdeteksi</span><strong>Login + urgency</strong></div><div><span>Status</span><strong>Perlu verifikasi</strong></div></div></div>`}function be(e,t){return e.mode===`qr`?`<div class="qr-preview"><span></span><span></span><span></span><i></i></div><div class="preview-caption">QR baru di area pembayaran</div>`:e.mode===`media`?`<div class="media-preview"><span class="media-face"></span><span class="media-body"></span><i></i><em></em></div><div class="preview-caption">Frame video / gambar yang dianalisis</div>`:e.mode===`link`?`<div class="link-preview"><strong>Bank Alert</strong><p>Rekening Anda akan diblokir dalam 30 menit.</p><code>https://secure-verifikasi.example/login</code></div>`:e.mode===`official`?`<div class="official-preview"><strong>Pemberitahuan Resmi</strong><p>${g(t)}</p><span>Perlu dicocokkan dengan aplikasi resmi.</span></div>`:`<div class="message-preview"><p>${g(t)}</p></div>`}function L(){let e=s(),t=c(),n=[[`J`,`Jeda`,e.aiNotices[0]?.[1]||`Tekanan perlu diperiksa`,Math.min(96,e.aiScore+6),`amber`],[`E`,`Emosi`,e.aiNotices[1]?.[1]||`Respons emosional terdeteksi`,Math.max(42,e.aiScore-9),`red`],[`D`,`Data`,e.aiNotices[2]?.[1]||`Bukti belum terkonfirmasi`,Math.max(48,e.aiScore-4),`blue`],[`A`,`Aksi`,e.aiNotices[3]?.[1]||`Tindakan berisiko terdeteksi`,Math.min(98,e.aiScore+3),`teal`]],r=e.aiScore>=80?`Risiko tinggi - verifikasi sebelum bertindak`:e.aiScore>=70?`Perlu verifikasi lebih lanjut`:`Sinyal sedang - periksa bukti resmi`;return`<section class="direct-detection-page"><div class="page-shell">
    ...
    <header class="direct-result-header"><div><p class="section-kicker">Hasil prediksi langsung</p><h1>AI menghadang empat sinyal sebelum tindakan.</h1><p>Hasil ini melewati latihan Human First dan game. Gunakan penjelasan XAI untuk menentukan apa yang masih perlu diverifikasi.</p></div><div class="direct-verdict"><span>${g(t.confidenceLabel)}</span><strong>${e.aiScore}%</strong><p>${g(r)}</p></div></header>
    <section class="ai-court-board" aria-label="Papan sinyal J.E.D.A. hasil prediksi AI"><div class="court-entry"><span>INPUT</span><i></i></div><div class="court-track">${n.map(([e,t,n,r,i],a)=>`<article class="court-signal ${i}"><div class="court-line"></div><span class="court-letter">${e}</span><div><small>GARIS 0${a+1}</small><strong>${t}</strong><p>${g(n)}</p><div class="court-score"><i style="--score:${r}%"></i><b>${r}</b></div></div></article>`).join(``)}</div><div class="court-gate"><span>AKSI</span><strong>${e.aiScore>=80?`TAHAN`:`CEK`}</strong></div></section>
    ${he(e,t)}
    <div class="ai-notice-grid">${e.aiNotices.map(([e,t])=>`<div class="signal-card"><small>${g(e)}</small><strong>${g(t)}</strong></div>`).join(``)}</div>
    <div class="ai-columns direct-ai-columns"><section class="info-panel unknown"><h3>Yang belum dapat dipastikan AI</h3><ul>${e.unknowns.map(e=>`<li>${g(e)}</li>`).join(``)}</ul></section><section class="info-panel verify"><h3>Langkah verifikasi berikutnya</h3><ul>${e.verification.map(e=>`<li>${g(e)}</li>`).join(``)}</ul></section></div>
  ...
  </div></section>`}function xe(){let e=s();return`<div class="flow-card">
    ...
    ${he(e,c())}
    <div class="ai-notice-grid">${e.aiNotices.map(([e,t])=>`<div class="signal-card"><small>${g(e)}</small><strong>${g(t)}</strong></div>`).join(``)}</div>
    <div class="forensic-meter"><div class="forensic-meter-head"><strong>${d.aiWrong?`Suspicious Signals`:`Manipulation Signals`}: ${e.aiLevel}</strong><span>${e.aiScore}% indikator model</span></div><div class="meter"><span style="width:${e.aiScore}%"></span></div><p>Nilai ini menunjukkan sinyal model, bukan kebenaran final. Gunakan hasil ini untuk menentukan apa yang perlu dicek, bukan untuk langsung percaya.</p></div>
    <div class="ai-columns">
      <section class="info-panel unknown"><h3>Yang belum dapat dipastikan AI</h3><ul>${e.unknowns.map(e=>`<li>${g(e)}</li>`).join(``)}</ul></section>
      <section class="info-panel verify"><h3>Yang dapat kamu verifikasi</h3><ul>${e.verification.map(e=>`<li>${g(e)}</li>`).join(``)}</ul></section>
    </div>
  ...
  </div>`}function Se(){let e=s(),t=d.aiWrong?[`Saya setuju dengan AI`,`Saya tidak setuju dengan AI`,`Verifikasi lagi`,`Belum yakin`]:[`Lanjut`,`Verifikasi Dulu`,`Berhenti`,`Belum Yakin`];return`<div class="flow-card">
    ...
    <div class="comparison"><div><span class="comparison-label">Penilaian awal saya</span><strong>${g(d.initialDecision)}</strong><p>Confidence: ${d.initialConfidence}%</p></div><div><span class="comparison-label">AI Lens</span><strong>${d.aiWrong?`Suspicious`:`Manipulation`} Signals: ${e.aiScore}%</strong><p>${g(e.aiNotices.slice(2).map(([e,t])=>`${e}: ${t}`).join(` · `))}</p></div></div>
    <div class="question"><span class="question-label">Setelah melihat bukti dan AI Lens, apa keputusanmu sekarang?</span><div class="choice-grid">${t.map(e=>M(e,d.finalDecision,`final-decision`)).join(``)}</div></div>
    <div class="question"><span class="question-label">Seberapa yakin kamu dengan keputusan final itu?</span>${j(`final-confidence`,d.finalConfidence)}</div>
    <div class="flow-actions"><button class="button button-ghost" data-action="back-to-ai">Kembali</button><button class="button button-teal" data-action="lock-final" ${d.finalDecision?``:`disabled`}>Kunci Keputusan Akhir</button></div>
  </div>`}function Ce(){return`<div class="flow-card">
    ...
    <div class="question"><div class="question-label">Pilih paling banyak dua faktor. <span class="max-note">${d.reflection.length}/2 dipilih</span></div><div class="choice-grid compact">${[`Bukti / sumber`,`Emosi`,`Tekanan waktu`,`Risiko tindakan`,`Analisis AI`,`Verifikasi independen`,`Tidak berubah`].map(e=>ne(e,d.reflection,`reflection`)).join(``)}</div></div>
    <div class="question"><span class="question-label">Jika AI bertentangan dengan bukti independen, mana yang seharusnya kamu prioritaskan?</span><div class="choice-grid">${[`AI`,`Bukti independen`,`Opini viral`,`Kanal resmi`,`Belum yakin`].map(e=>M(e,d.priority,`priority`)).join(``)}</div></div>
    ${d.priority&&![`Bukti independen`,`Kanal resmi`].includes(d.priority)?`<div class="insight"><div><strong>Berhenti sejenak.</strong><br>Pertimbangkan kembali sumber mana yang dapat diverifikasi secara independen.</div></div>`:``}
    <div class="flow-actions"><button class="button button-ghost" data-action="back-to-final">Kembali</button><button class="button button-teal" data-action="show-result" ${d.reflection.length&&d.priority?``:`disabled`}>Lihat Snapshot Nalar</button></div>
  </div>`}function R(){let e=s(),t=[`Verifikasi Dulu`,`Berhenti`,`Saya tidak setuju dengan AI`,`Verifikasi lagi`].includes(d.finalDecision),n=[[`Mengenali tekanan`,d.pressure.length>1?88:76],[`Kesadaran emosi`,d.emotion.length>1?84:72],[`Pemeriksaan bukti`,d.evidence===e.preferredEvidence?92:70],[`Kesadaran risiko aksi`,d.saferAction?86:68]];return`<div class="flow-card">
    <header><p class="section-kicker">Critical Thinking Snapshot</p><h2>${d.aiWrong&&d.finalDecision===`Saya tidak setuju dengan AI`?`Penilaian baik. AI bukan otoritas final.`:`Pemeriksaan selesai.`}</h2><p>${t?`Kamu memberi ruang bagi bukti baru sebelum menentukan tindakan.`:`Snapshot ini menunjukkan area yang bisa diperkuat pada pemeriksaan berikutnya.`}</p></header>
    ...
    <div class="before-after"><div class="snapshot-box"><small>Sebelum</small><strong>${g(d.initialDecision)} - ${d.initialConfidence}% yakin</strong></div><span class="arrow" aria-hidden="true">&#8594;</span><div class="snapshot-box after"><small>Sesudah</small><strong>${g(d.finalDecision)} - ${d.finalConfidence}% yakin</strong></div></div>
  ...
  </div>`}var we=[`Keluarga`,`Dewasa & Lansia`,`Sekolah`,`Komunitas Umum`],z=[`30 menit`,`60 menit`,`90 menit`],B=[{id:`family`,title:`Keluarga & Keuangan`,format:`Teks + Voice Note`,caseTitle:`Pesan Keluarga Darurat`,content:e,note:`Fokus pada urgency, identitas, dan transfer yang sulit dibatalkan.`},{id:`public`,title:`Hoaks di Ruang Publik`,format:`Screenshot + Video`,caseTitle:`Informasi Viral`,content:`Mereka tidak ingin kamu tahu fakta ini. Sebarkan sekarang sebelum unggahan dihapus!`,note:`Fokus pada sumber primer, konteks, dan tekanan untuk membagikan.`},{id:`transaction`,title:`Aman Bertransaksi`,format:`QR + Tautan`,caseTitle:`QR Pembayaran`,content:`QR di meja kasir sedang bermasalah. Scan kode baru ini agar pembayaran langsung diproses.`,note:`Fokus pada penerima, domain tujuan, dan kanal pembayaran resmi.`}],V={mode:`setup`,audience:`Dewasa & Lansia`,duration:`60 menit`,packId:`family`,participants:24,phase:0,completedLines:[]};function Te(){return B.find(e=>e.id===V.packId)||B[0]}function Ee(){return`<section class="page-hero community-hero"><div class="page-shell"><p class="eyebrow">HADANGIN &middot; Ruang Komunitas</p><h1>Berlatih Berpikir Kritis Bersama.</h1><p>Fasilitasi permainan J.E.D.A. untuk keluarga, kelompok dewasa, sekolah, atau komunitas. Satu layar, satu kasus, dan ruang diskusi yang aman sebelum mengambil keputusan.</p></div></section>
    ${V.mode===`setup`?De():Oe()}`}function De(){let e=Te();return`<section class="section community-workspace"><div class="page-shell community-setup-layout">
    <section class="community-builder" aria-labelledby="community-builder-title">
      ...
      <div class="community-field"><span class="community-field-label">Kelompok peserta</span><div class="community-choice-row">${we.map(e=>`<button type="button" class="${V.audience===e?`active`:``}" data-community-audience="${g(e)}">${g(e)}</button>`).join(``)}</div></div>
      <div class="community-field"><span class="community-field-label">Durasi sesi</span><div class="community-segmented">${z.map(e=>`<button type="button" class="${V.duration===e?`active`:``}" data-community-duration="${g(e)}">${g(e)}</button>`).join(``)}</div></div>
      <div class="community-field"><span class="community-field-label">Paket kasus</span><div class="community-pack-grid">${B.map(e=>`<button type="button" class="community-pack ${V.packId===e.id?`active`:``}" data-community-pack="${e.id}"><span>${g(e.format)}</span><strong>${g(e.title)}</strong><small>${g(e.note)}</small></button>`).join(``)}</div></div>
    ...
    <aside class="community-session-preview" aria-label="Ringkasan sesi yang akan dibuat">
      ...
      <div class="community-preview-case"><small>Kasus pembuka</small><strong>${g(e.caseTitle)}</strong><blockquote>${g(e.content)}</blockquote></div>
      <dl><div><dt>Peserta</dt><dd>${g(V.audience)}</dd></div><div><dt>Durasi</dt><dd>${g(V.duration)}</dd></div><div><dt>Format</dt><dd>${g(e.format)}</dd></div></dl>
  ...
  </div></section>`}function Oe(){let e=[`Voting Awal`,`Diskusi J.E.D.A.`,`Voting Akhir`,`Debrief`],t=Te();return`<section class="community-live"><div class="page-shell">
    <div class="community-live-topbar"><div><span>Kode ruang</span><strong>HAD-204</strong><small>Mode fasilitator lokal</small></div><div class="community-phase-track">${e.map((e,t)=>`<span class="${t<V.phase?`done`:t===V.phase?`active`:``}">${t<V.phase?`&#10003;`:t+1}<small>${e}</small></span>`).join(``)}</div><button class="button button-ghost button-small" type="button" data-action="reset-community">Akhiri Sesi</button></div>
    ${Ae(t)}
  </div></section>`}function ke(e=!1){return`<div class="community-votes">${(e?[[`Lanjut`,9],[`Verifikasi Dulu`,57],[`Berhenti`,25],[`Belum Yakin`,9]]:[[`Lanjut`,42],[`Verifikasi Dulu`,28],[`Berhenti`,12],[`Belum Yakin`,18]]).map(([e,t])=>`<div><span>${g(e)}</span><i><b style="width:${t}%"></b></i><strong>${Math.max(1,Math.round(V.participants*t/100))}</strong></div>`).join(``)}</div>`}function Ae(e){if(V.phase===0)return`<div class="community-stage-layout"><section class="community-projection"><div class="projection-label"><span>Ditampilkan kepada peserta</span><b>${g(e.format)}</b></div><p class="projection-source">${g(e.caseTitle)}</p><blockquote>${g(e.content)}</blockquote><div class="projection-question">Apa respons pertamamu jika menerima informasi ini?</div></section><aside class="community-facilitator-panel"><p class="section-kicker">Penilaian awal</p><h2>Respons sebelum petunjuk diberikan</h2><p>Jumlah di bawah adalah dataset demo sesuai ${V.participants} peserta.</p>${ke(!1)}<button class="button" type="button" data-action="community-next">Mulai Diskusi J.E.D.A. &#8594;</button></aside></div>`;if(V.phase===1){let e=[[`J`,`Jeda`,`Tekanan apa yang membuat kita ingin segera bereaksi?`],[`E`,`Emosi`,`Emosi siapa yang sedang dipengaruhi dan bagaimana caranya?`],[`D`,`Data`,`Bukti independen apa yang perlu dicari?`],[`A`,`Aksi`,`Apa risiko tindakan dan alternatif yang lebih aman?`]],t=V.completedLines.length===e.length;return`<section class="community-jeda-stage"><header><p class="section-kicker">Empat pos diskusi</p><h2>Bergerak melewati garis nalar.</h2><p>Klik setiap pos setelah kelompok menyelesaikan diskusinya.</p></header><div class="community-jeda-lines">${e.map(([e,t,n],r)=>`<button type="button" class="${V.completedLines.includes(e)?`complete`:``}" data-community-line="${e}"><span>${e}</span><small>POS 0${r+1}</small><strong>${t}</strong><p>${n}</p><i>${V.completedLines.includes(e)?`Selesai`:`Tandai selesai`}</i></button>`).join(``)}</div><div class="community-stage-actions"><span>${V.completedLines.length} dari 4 pos selesai</span><button class="button" type="button" data-action="community-next" ${t?``:`disabled`}>Buka Voting Akhir &#8594;</button></div></section>`}return V.phase===2?`<div class="community-stage-layout"><section class="community-projection final"><div class="projection-label"><span>Voting setelah J.E.D.A.</span><b>Human Final</b></div><h2>Apakah keputusan kelompok berubah?</h2><p>Bandingkan respons akhir dengan keputusan sebelum diskusi.</p><div class="community-shift"><div><small>Sebelum</small><strong>42%</strong><span>langsung lanjut</span></div><i aria-hidden="true">&#8594;</i><div><small>Sesudah</small><strong>82%</strong><span>verifikasi atau berhenti</span></div></div></section><aside class="community-facilitator-panel"><p class="section-kicker">Voting akhir</p><h2>Keputusan kelompok</h2>${ke(!0)}<button class="button button-teal" type="button" data-action="community-next">Lihat Debrief &#8594;</button></aside></div>`:`<section class="community-debrief"><header><p class="section-kicker">Ringkasan sesi</p><h2>Kelompok memberi ruang lebih besar untuk verifikasi.</h2><p>Hasil berikut adalah data demo yang menunjukkan format laporan ketika backend multi-perangkat tersedia.</p></header><div class="community-impact-grid"><article><span>Perubahan aman</span><strong>+54%</strong><p>Peserta beralih ke verifikasi atau berhenti.</p></article><article><span>Pos selesai</span><strong>4/4</strong><p>Semua pertanyaan J.E.D.A. didiskusikan.</p></article><article><span>Peserta</span><strong>${V.participants}</strong><p>${g(V.audience)} &middot; ${g(V.duration)}</p></article></div><div class="community-learning"><div><strong>Temuan diskusi</strong><p>Tekanan waktu dan identitas pengirim menjadi dua sinyal yang paling cepat dikenali. Pemeriksaan bukti independen masih perlu dilatih.</p></div><div><strong>Tindak lanjut</strong><p>Ulangi latihan dengan paket media berbeda dan minta peserta membawa satu strategi verifikasi untuk dipraktikkan di rumah.</p></div></div><div class="community-stage-actions"><button class="button button-secondary" type="button" data-action="download-community-kit">Unduh Panduan Sesi</button><button class="button" type="button" data-action="reset-community">Buat Sesi Baru</button></div></section>`}function je(){let e=Te(),t=`PANDUAN SESI HADANGIN\n\nAudiens: ${V.audience}\nDurasi: ${V.duration}\nPeserta: ${V.participants}\nPaket: ${e.title}\nKasus: ${e.caseTitle}\n\nALUR\n1. Voting awal tanpa petunjuk AI.\n2. Jeda: kenali tekanan untuk segera bereaksi.\n3. Emosi: identifikasi emosi yang sedang dipengaruhi.\n4. Data: tentukan bukti independen yang perlu dicari.\n5. Aksi: nilai risiko dan alternatif yang lebih aman.\n6. Voting akhir dan debrief.\n\nPRIVASI\nGunakan skenario yang telah dianonimkan. Jangan tampilkan pesan pribadi peserta pada layar bersama.\n`,n=document.createElement(`a`);n.href=URL.createObjectURL(new Blob([t],{type:`text/plain;charset=utf-8`})),n.download=`panduan-sesi-hadangin.txt`,n.click(),setTimeout(()=>URL.revokeObjectURL(n.href),0),_(`Panduan sesi berhasil diunduh.`)}var Me={summary:[[`Pemeriksaan simulatif`,`128`,`+24 minggu ini`],[`Safer decision shift`,`64%`,`berubah ke verifikasi/berhenti`],[`MIL Habit Score`,`78`,`rata-rata dari 100`],[`Forward risk turun`,`34 pts`,`sebelum vs sesudah J.E.D.A.`]],before:[[`Lanjut`,42],[`Verifikasi Dulu`,28],[`Berhenti`,12],[`Belum Yakin`,18]],after:[[`Lanjut`,9],[`Verifikasi Dulu`,57],[`Berhenti`,25],[`Belum Yakin`,9]],patterns:[[`Urgency`,87],[`Fear`,73],[`Fake Authority`,59],[`Emotional Clickbait`,54],[`Suspicious Link`,41],[`Synthetic Media`,33],[`Financial Request`,28]],media:[[`Text / WhatsApp`,46],[`Image / Screenshot`,24],[`QR / Link`,18],[`Audio / Voice Note`,12]],jeda:[[`Jeda`,82,`User mulai mengenali tekanan waktu.`],[`Emosi`,76,`Fear dan urgency paling sering memengaruhi respons.`],[`Data`,71,`Masih perlu latihan memilih bukti independen.`],[`Aksi`,79,`Risiko transfer/klik makin terlihat sebelum bertindak.`]],explainability:[[`Visual highlights dilihat`,89],[`Pertanyaan reflektif dijawab`,76],[`Bukti independen dipilih`,68],[`Tidak mengikuti AI saat bukti lebih kuat`,22]],scenarios:[[`Pesan Keluarga Darurat`,`92%`,`+48%`,`Percaya nomor baru`],[`QR Pembayaran`,`81%`,`+36%`,`Tidak cek penerima`],[`Lowongan Kerja`,`77%`,`+42%`,`Percaya logo/testimoni`],[`AI Bisa Salah`,`69%`,`+25%`,`Terlalu percaya AI`]]};function Ne([e,t],n=``){return`<div class="dash-bar-row ${n}"><div><span>${g(e)}</span><b>${t}%</b></div><i style="--bar:${t}%"></i></div>`}function Pe(){return`<section class="page-hero dashboard-hero"><div class="page-shell"><p class="eyebrow">Prototype analytics simulation</p><h1>HADANGIN Insight Dashboard</h1><p>Dashboard simulatif untuk menunjukkan dampak pembelajaran MIL: bagaimana pengguna pause, verify, reflect, decide, dan mengurangi risiko forward impulsif.</p></div></section>
    <section class="section dashboard-section"><div class="page-shell">
      ...
      <div class="metric-grid">${Me.summary.map(([e,t,n])=>`<article class="metric-card"><span>${g(e)}</span><strong>${g(t)}</strong><p>${g(n)}</p></article>`).join(``)}</div>
      <div class="dashboard-grid two">
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">Before vs after</p><h2>Perubahan keputusan pengguna</h2><p>Dari respons reaktif menuju verifikasi atau berhenti sebelum share.</p></div><div class="judgment-compare"><section><h3>Sebelum J.E.D.A.</h3>${Me.before.map(e=>Ne(e,`before`)).join(``)}</section><section><h3>Sesudah AI Lens</h3>${Me.after.map(e=>Ne(e,`after`)).join(``)}</section></div></article>
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">Pattern map</p><h2>Pola manipulasi dominan</h2><p>Insight untuk educator, komunitas, dan peneliti MIL.</p></div><div class="pattern-list">${Me.patterns.map(([e,t])=>Ne([e,t],`pattern`)).join(``)}</div></article>
      </div>
      <div class="dashboard-grid two compact">
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">Multimodal input</p><h2>Jenis konten diperiksa</h2></div><div class="media-donut" aria-label="Distribusi tipe media"><span>46%</span></div><div class="media-list">${Me.media.map(([e,t])=>`<p><i style="--dot:${t}%"></i><span>${g(e)}</span><b>${t}%</b></p>`).join(``)}</div></article>
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">J.E.D.A. growth</p><h2>Skill literasi yang terbentuk</h2></div><div class="skill-list dashboard-skills">${Me.jeda.map(([e,t,n])=>`<div class="skill-row"><span>${g(e)}<small>${g(n)}</small></span><div class="skill-bar"><i style="width:${t}%"></i></div><b>${t}</b></div>`).join(``)}</div></article>
      </div>
      <div class="dashboard-grid two compact">
        <article class="dashboard-card"><div class="dash-card-head"><p class="section-kicker">Explainability engagement</p><h2>Apakah pengguna belajar dari clue?</h2></div><div class="explain-grid">${Me.explainability.map(([e,t])=>`<div><strong>${t}%</strong><span>${g(e)}</span></div>`).join(``)}</div></article>
    ...
    <section class="section training-arena-section" id="training-arenas"><div class="page-shell">
      ...
      <div class="scenario-grid">${n.map(e=>`<article class="scenario-card ${e.featured?`featured`:``}" data-scenario-card="${e.id}"><div class="scenario-card-top"><span class="scenario-no">${e.no}</span><span class="scenario-format scenario-format-${e.inputType}">${g(e.format)}</span></div><h3>${e.title}</h3><p>${e.description}</p><div class="scenario-source"><span>Sumber kasus</span><strong>${g(e.source)}</strong></div><div class="scenario-mission"><span>Misi latihan</span><p>${g(e.mission)}</p></div><div class="chip-row">${e.triggers.map(t=>`<span class="chip ${e.featured?`chip-terra`:``}">${t}</span>`).join(``)}</div><button class="button ${e.featured?``:`button-secondary`}" data-scenario="${e.id}">Buka Arena ${g(e.format)}</button></article>`).join(``)}</div>
    </div></section>`}function Ie(){return`<section class="page-hero"><div class="page-shell"><p class="eyebrow">Cara Kerja</p><h1>Bagaimana HADANGIN Bekerja?</h1><p>HADANGIN adalah Indonesian-localized prototype dari AI Context Guard Web: menggabungkan psikologi, Media and Information Literacy, AI forensics, dan human judgment dalam satu alur reflektif.</p></div></section>
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function nc(e,t,n){let r=new Float32Array(Hs),i=new q(0,1,0);return new bo({name:`SphericalGaussianBlur`,defines:{n:Hs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ac(),fragmentShader:`
	...
	`}var oc=class extends xr{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new to(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
