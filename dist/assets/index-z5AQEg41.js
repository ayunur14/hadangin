...
`,c=document.createElement(`a`);c.href=URL.createObjectURL(new Blob([s],{type:`text/plain;charset=utf-8`})),c.download=t?V.mode===`vision`?`hadangin-ai-camera-arena-guide.txt`:`hadangin-community-session-guide.txt`:V.mode===`vision`?`panduan-arena-kamera-hadangin.txt`:`panduan-sesi-hadangin.txt`,c.click(),setTimeout(()=>URL.revokeObjectURL(c.href),0),Ke(t?`Session guide downloaded.`:`Panduan sesi berhasil diunduh.`)}function cn(){let e=Le()===`en`,t=e?[[`J`,`PAUSE`,`Pause briefly and identify the time pressure.`],[`E`,`EMOTION`,`Recognize the emotion being influenced.`],[`D`,`EVIDENCE`,`Choose the strongest independent evidence.`],[`A`,`ACTION`,`Assess the risk and choose a safer action.`],[`&#8594;`,`PROCEED`,`I will take the requested action.`],[`?`,`VERIFY`,`I will check through another channel.`],[`&#9632;`,`STOP`,`I will not continue the action.`],[`...`,`NOT SURE`,`I need more evidence.`],[`!`,`URGENCY`,`Reduce the other team's time by five seconds.`],[`ID`,`AUTHORITY`,`Use a claim tied to an institution or position.`],[`!`,`FEAR`,`Emphasize a threat or emergency.`],[`+`,`SOCIAL PRESSURE`,`Use virality as pressure.`]]:[[`J`,`JEDA`,`Berhenti sejenak. Temukan tekanan waktu.`],[`E`,`EMOSI`,`Kenali emosi yang sedang dipengaruhi.`],[`D`,`DATA`,`Pilih bukti independen yang paling kuat.`],[`A`,`AKSI`,`Nilai risiko dan pilih tindakan yang aman.`],[`&#8594;`,`LANJUT`,`Saya akan melakukan tindakan yang diminta.`],[`?`,`VERIFIKASI`,`Saya akan memeriksa lewat kanal lain.`],[`&#9632;`,`BERHENTI`,`Saya tidak akan melanjutkan tindakan.`],[`...`,`BELUM YAKIN`,`Saya membutuhkan bukti tambahan.`],[`!`,`URGENCY`,`Kurangi waktu lawan lima detik.`],[`ID`,`AUTHORITY`,`Gunakan klaim institusi atau jabatan.`],[`!`,`FEAR`,`Tekankan ancaman atau keadaan darurat.`],[`+`,`SOCIAL PRESSURE`,`Gunakan viralitas sebagai tekanan.`]],n=e?{title:`HADANGIN · Blocking Arena Kit`,instruction:`Cut along the card borders. Laminate the cards for repeated use.`,print:`Print`,token:`INFORMATION TOKEN`,lines:[`J · PAUSE`,`E · EMOTION`,`D · EVIDENCE`,`A · ACTION`,`ACTION ZONE`],safety:`Safety: use without physical contact, avoid slippery floors, and adapt movement distances to participants' needs.`}:{title:`HADANGIN · Arena Hadang`,instruction:`Potong kartu mengikuti batas. Laminasi bila akan digunakan berulang.`,print:`Cetak`,token:`TOKEN INFORMASI`,lines:[`J · JEDA`,`E · EMOSI`,`D · DATA`,`A · AKSI`,`ZONA TINDAKAN`],safety:`Keamanan: gunakan tanpa kontak fisik, hindari lantai licin, dan sesuaikan jarak gerak dengan kebutuhan peserta.`},r=e?`
    ...
    <section class="section section-dark"><div class="page-shell"><div class="section-header"><p class="section-kicker">Untuk siapa</p><h2>Literasi yang dekat dengan kehidupan digital sehari-hari</h2><p>Ditujukan bagi pengguna digital, anak muda, keluarga, komunitas, pendidik, organisasi pemuda, advokat MIL, peneliti, dan pemangku kebijakan.</p></div><div class="chip-row"><span class="chip chip-blue">Everyday Digital Users</span><span class="chip chip-blue">Youth &amp; Young Adults</span><span class="chip chip-blue">Family &amp; Community</span><span class="chip chip-terra">Educators</span><span class="chip chip-terra">MIL Advocates</span><span class="chip chip-terra">Researchers</span></div></div></section>`}function bn(){return`<section class="enterprise-hero"><img src="${N}" alt="" aria-hidden="true" /><div class="page-shell enterprise-hero-grid"><div><p class="eyebrow">Future Expansion &middot; Enterprise</p><h1>Dari kebiasaan individu menuju ketahanan informasi institusi.</h1><p>HADANGIN dirancang berkembang dari prototipe literasi menjadi lapisan intervensi perilaku untuk pendidikan, organisasi, dan newsroom, dengan manusia tetap memegang keputusan akhir.</p><div class="enterprise-hero-actions"><a class="button" href="#/verify">Jelajahi Prototipe <span aria-hidden="true">&#8594;</span></a><a class="button button-secondary" href="#/community">Lihat Mode Komunitas</a></div></div><aside class="enterprise-positioning"><span>ARAH PRODUK</span><strong>Satu metode, tiga konteks institusional.</strong><div><p><b>01</b> Human First</p><p><b>02</b> AI + XAI</p><p><b>03</b> Human Final</p></div><small>Konsep roadmap untuk kemitraan dan pilot.</small></aside></div></section>
    <section class="section enterprise-expansion"><div class="page-shell"><div class="enterprise-section-head"><div><p class="section-kicker">Ekspansi masa depan</p><h2>Tiga jalur produk dengan fondasi MIL yang sama.</h2></div><p>Setiap versi menyesuaikan skenario, bahasa risiko, alur kerja, dan ukuran dampak tanpa mengubah prinsip HADANGIN: jeda sebelum tindakan.</p></div><div class="enterprise-offer-grid">${[{code:`EDU`,title:`HADANGIN untuk Pendidikan`,audience:`Sekolah dan universitas`,description:`Pembelajaran MIL berbasis permainan untuk melatih siswa berhenti, memeriksa bukti, dan merefleksikan keputusan sebelum bereaksi terhadap informasi.`,features:[`Modul skenario sesuai tingkat belajar`,`Mode kelas dan kit fasilitator`,`Insight pembelajaran tingkat kelompok`],outcome:`Kebiasaan literasi yang dapat dipraktikkan dan diukur`,subscription:`Lisensi pembelajaran per institusi`,delivery:`Akses tahunan untuk modul kelas, kit fasilitator, dan dashboard kelompok. Pilot disesuaikan dengan jumlah kelas dan dukungan implementasi.`},{code:`ORG`,title:`HADANGIN untuk Organisasi`,audience:`Tim, perusahaan, dan institusi`,description:`Membantu pegawai mengambil jeda sebelum menanggapi phishing, impersonation, permintaan transfer, dan tindakan social engineering.`,features:[`Simulasi berbasis risiko organisasi`,`Latihan phishing dan impersonation`,`Dashboard perubahan keputusan`],outcome:`Lebih sedikit tindakan impulsif pada momen berisiko`,subscription:`Langganan ketahanan tenaga kerja`,delivery:`Akses tahunan berbasis pengguna aktif, paket simulasi risiko, serta insight agregat untuk tim keamanan dan pembelajaran.`},{code:`NEWS`,title:`HADANGIN untuk Newsroom`,audience:`Jurnalis dan tim editorial`,description:`Mendukung jurnalis menilai sumber mencurigakan, petunjuk manipulasi, dan risiko informasi sebelum engagement atau publikasi.`,features:[`Intake sumber multimodal`,`XAI untuk petunjuk manipulasi`,`Checkpoint verifikasi editorial`],outcome:`Keputusan publikasi yang lebih transparan dan terlacak`,subscription:`Lisensi workspace editorial`,delivery:`Akses tahunan per newsroom untuk intake sumber, checkpoint editorial, dan riwayat keputusan yang dapat ditinjau.`}].map((e,t)=>`<article class="enterprise-offer"><div class="enterprise-offer-top"><span>${e.code}</span><small>0${t+1} / MODUL MASA DEPAN</small></div><p class="enterprise-audience">${e.audience}</p><h3>${e.title}</h3><p>${e.description}</p><ul>${e.features.map(e=>`<li>${e}</li>`).join(``)}</ul><div class="enterprise-outcome"><span>Hasil yang dituju</span><strong>${e.outcome}</strong></div><details class="enterprise-subscription"><summary>Subscription <span aria-hidden="true">+</span></summary><div><span class="enterprise-future-status">Konsep &middot; Belum tersedia</span><small>MODEL BISNIS MASA DEPAN</small><strong>${e.subscription}</strong><p>${e.delivery}</p><button class="button button-small" type="button" data-scroll-to="enterprise-partnership">Jelajahi Konsep Pilot <span aria-hidden="true">&#8594;</span></button></div></details></article>`).join(``)}</div></div></section>
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bl(e,t,n){let r=new Float32Array(El),i=new q(0,1,0);return new ic({name:`SphericalGaussianBlur`,defines:{n:El,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ul(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vl(){return new ic({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ul(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hl(){return new ic({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ul(),fragmentShader:`
	...
	`}var Wl=class extends aa{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Bs(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
